...
fn misc_bundle_benchmark(c: &mut Criterion) {
  walltime_bundle_benchmark_case(c, "misc-development");
  walltime_bundle_benchmark_case(c, "misc-production-sourcemap");
}
