      ...
      RawStringSource::from_static("/* ESM import */var _src_f0__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./src/f0 */ \"./src/f0.jsx\");\n").boxed(),
      {
        let mut source = ReplaceSource::new(
          SourceMapSource::new(SourceMapSourceOptions {
            ...
            source_map: SourceMap::from_json("{\"version\":3,\"sources\":[\"/rspack-ecosystem-benchmark/cases/10000/index.jsx\"],\"sourcesContent\":[\"\\nimport React, { useEffect } from \\\"react\\\";\\nimport ReactDom from \\\"react-dom/client\\\";\\nimport App1 from \\\"./src/f0\\\";\\n\\nReactDom.createRoot(document.getElementById(\\\"root\\\")).render(\\n\\t<React.StrictMode>\\n\\t\\t<App1 />\\n\\t</React.StrictMode>\\n);\\n\\n\\t\\t\\n\\t\\t\"],\"names\":[\"React\",\"ReactDom\",\"App1\",\"document\"],\"mappings\":\";AACA,OAAOA,WAA0B,QAAQ;AACzC,OAAOC,cAAc,mBAAmB;AACxC,OAAOC,UAAU,WAAW;AAE5BD,SAAS,UAAU,CAACE,SAAS,cAAc,CAAC,SAAS,MAAM,eAC1D,KAACH,MAAM,UAAU;cAChB,mBAACE\"}".to_string()).unwrap(),
      ...
      RawStringSource::from_static("/* ESM import */var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ \"../../node_modules/.pnpm/react@18.2.0/node_modules/react/index.js\");\n/* ESM import */var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);\n").boxed(),
      {
        let mut source = ReplaceSource::new(
          SourceMapSource::new(SourceMapSourceOptions {
            ...
            source_map: SourceMap::from_json("{\"version\":3,\"sources\":[\"/rspack-ecosystem-benchmark/cases/10000/src/d0/d0/d0/d0/f0.jsx\"],\"sourcesContent\":[\"\\n\\nimport React, {useEffect} from 'react'\\nimport Icon  from '@icon-park/react/es/all';\\n\\n\\nfunction Navbar({ show }) {\\nuseEffect(() => {\\n  console.log(Date.now());\\n})\\nreturn (\\n  <div>\\n  <span>    19  </span>\\n  {Date.now()}\\n  </div>\\n)\\n}\\n\\nexport default Navbar\\n\\n\\n\"],\"names\":[\"React\",\"useEffect\",\"Navbar\",\"param\",\"show\",\"console\",\"Date\"],\"mappings\":\";AAEA,OAAOA,SAAQC,SAAS,QAAO,QAAO;AAItC,SAASC,OAAOC,KAAQ;QAARA,AAAEC,OAAFD,MAAEC;IAClBH,UAAU;QACRI,QAAQ,GAAG,CAACC,KAAK,GAAG;IACtB;IACA,qBACE,MAAC;;0BACD,KAAC;0BAAK;;YACLA,KAAK,GAAG;;;AAGX;AAEA,eAAeJ,OAAM\"}".to_string()).unwrap(),
            original_source: None,
            inner_source_map: None,
            remove_original_source: false,
          }).boxed()
      ...
      RawStringSource::from_static("/* ESM import */var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ \"../../node_modules/.pnpm/react@18.2.0/node_modules/react/index.js\");\n/* ESM import */var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);\n").boxed(),
      {
        let mut source = ReplaceSource::new(
          SourceMapSource::new(SourceMapSourceOptions {
            ...
            source_map: SourceMap::from_json("{\"version\":3,\"sources\":[\"/rspack-ecosystem-benchmark/cases/10000/src/d0/d0/d0/d0/f1.jsx\"],\"sourcesContent\":[\"\\n  import React from 'react'\\n  import Icon  from '@icon-park/react/es/all';\\n\\n  \\n  function Navbar({ show }) {\\n    return (\\n      <div>\\n      \\n      </div>\\n    )\\n  }\\n  \\n  export default Navbar\\n  \"],\"names\":[\"React\",\"Navbar\",\"param\",\"show\"],\"mappings\":\";AACE,OAAOA,WAAW,QAAO;AAIzB,SAASC,OAAOC,KAAQ;QAARA,AAAEC,OAAFD,MAAEC;IAChB,qBACE,KAAC;AAIL;AAEA,eAAeF,OAAM\"}".to_string()).unwrap(),
            original_source: None,
            inner_source_map: None,
            remove_original_source: false,
          }).boxed()
      ...
      RawStringSource::from_static("/* ESM import */var _d9_f8_jsx__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./d9/f8.jsx */ \"./src/d0/d0/d0/d9/f8.jsx\");\n").boxed(),
      {
        let mut source = ReplaceSource::new(
          SourceMapSource::new(SourceMapSourceOptions {
            ...
            source_map: SourceMap::from_json("{\"version\":3,\"sources\":[\"/rspack-ecosystem-benchmark/cases/10000/src/d0/d0/d0/f8.jsx\"],\"sourcesContent\":[\"\\n  import React from 'react'\\n  import Icon  from '@icon-park/react/es/all';\\n\\n  import Component__0 from './d8/f0.jsx'\\nimport Component__1 from './d8/f1.jsx'\\nimport Component__2 from './d8/f2.jsx'\\nimport Component__3 from './d8/f3.jsx'\\nimport Component__4 from './d8/f4.jsx'\\nimport Component__5 from './d8/f5.jsx'\\nimport Component__6 from './d8/f6.jsx'\\nimport Component__7 from './d8/f7.jsx'\\nimport Component__8 from './d8/f8.jsx'\\nimport Component__9 from './d9/f0.jsx'\\nimport Component__10 from './d9/f1.jsx'\\nimport Component__11 from './d9/f2.jsx'\\nimport Component__12 from './d9/f3.jsx'\\nimport Component__13 from './d9/f4.jsx'\\nimport Component__14 from './d9/f5.jsx'\\nimport Component__15 from './d9/f6.jsx'\\nimport Component__16 from './d9/f7.jsx'\\nimport Component__17 from './d9/f8.jsx'\\n  function Navbar({ show }) {\\n    return (\\n      <div>\\n      <Component__0/>\\n<Component__1/>\\n<Component__2/>\\n<Component__3/>\\n<Component__4/>\\n<Component__5/>\\n<Component__6/>\\n<Component__7/>\\n<Component__8/>\\n<Component__9/>\\n<Component__10/>\\n<Component__11/>\\n<Component__12/>\\n<Component__13/>\\n<Component__14/>\\n<Component__15/>\\n<Component__16/>\\n<Component__17/>\\n      </div>\\n    )\\n  }\\n  \\n  export default Navbar\\n  \"],\"names\":[\"React\",\"Component__0\",\"Component__1\",\"Component__2\",\"Component__3\",\"Component__4\",\"Component__5\",\"Component__6\",\"Component__7\",\"Component__8\",\"Component__9\",\"Component__10\",\"Component__11\",\"Component__12\",\"Component__13\",\"Component__14\",\"Component__15\",\"Component__16\",\"Component__17\",\"Navbar\",\"param\",\"show\"],\"mappings\":\";AACE,OAAOA,WAAW,QAAO;AAGzB,OAAOC,kBAAkB,cAAa;AACxC,OAAOC,kBAAkB,cAAa;AACtC,OAAOC,kBAAkB,cAAa;AACtC,OAAOC,kBAAkB,cAAa;AACtC,OAAOC,kBAAkB,cAAa;AACtC,OAAOC,kBAAkB,cAAa;AACtC,OAAOC,kBAAkB,cAAa;AACtC,OAAOC,kBAAkB,cAAa;AACtC,OAAOC,kBAAkB,cAAa;AACtC,OAAOC,kBAAkB,cAAa;AACtC,OAAOC,mBAAmB,cAAa;AACvC,OAAOC,mBAAmB,cAAa;AACvC,OAAOC,mBAAmB,cAAa;AACvC,OAAOC,mBAAmB,cAAa;AACvC,OAAOC,mBAAmB,cAAa;AACvC,OAAOC,mBAAmB,cAAa;AACvC,OAAOC,mBAAmB,cAAa;AACvC,OAAOC,mBAAmB,cAAa;AACrC,SAASC,OAAOC,KAAQ;QAARA,AAAEC,OAAFD,MAAEC;IAChB,qBACE,MAAC;;0BACD,KAACpB;0BACP,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;0BACD,KAACC;;;AAGC;AAEA,eAAeC,OAAM\"}".to_string()).unwrap(),
            original_source: None,
            inner_source_map: None,
            remove_original_source: false,
          }).boxed()
      ...
      RawStringSource::from_static("/* ESM import */var _d0_f0_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./d0/f0.jsx */ \"./src/d0/f0.jsx\");\n").boxed(),
      {
        let mut source = ReplaceSource::new(
          SourceMapSource::new(SourceMapSourceOptions {
            ...
            source_map: SourceMap::from_json("{\"version\":3,\"sources\":[\"/rspack-ecosystem-benchmark/cases/10000/src/f0.jsx\"],\"sourcesContent\":[\"\\nimport React from 'react'\\nimport Icon  from '@icon-park/react/es/all';\\n\\nimport Component__0 from './d0/f0.jsx'\\n// import Component__1 from './d0/f1.jsx'\\n// import Component__2 from './d0/f2.jsx'\\n// import Component__3 from './d0/f3.jsx'\\n// import Component__4 from './d0/f4.jsx'\\n// import Component__5 from './d0/f5.jsx'\\n// import Component__6 from './d0/f6.jsx'\\n// import Component__7 from './d0/f7.jsx'\\n// import Component__8 from './d0/f8.jsx'\\nfunction Navbar({ show }) {\\nreturn (\\n  <div>\\n  9\\n  <Component__0/>\\n{/* <Component__1/>\\n<Component__2/>\\n<Component__3/>\\n<Component__4/>\\n<Component__5/>\\n<Component__6/>\\n<Component__7/>\\n<Component__8/> */}\\n  </div>\\n)\\n}\\n\\nexport default Navbar\\n\\n\\n\"],\"names\":[\"React\",\"Component__0\",\"Navbar\",\"param\",\"show\"],\"mappings\":\";AACA,OAAOA,WAAW,QAAO;AAGzB,OAAOC,kBAAkB,cAAa;AACtC,yCAAyC;AACzC,yCAAyC;AACzC,yCAAyC;AACzC,yCAAyC;AACzC,yCAAyC;AACzC,yCAAyC;AACzC,yCAAyC;AACzC,yCAAyC;AACzC,SAASC,OAAOC,KAAQ;QAARA,AAAEC,OAAFD,MAAEC;IAClB,qBACE,MAAC;;YAAI;0BAEL,KAACH;;;AAWH;AAEA,eAAeC,OAAM\"}".to_string()).unwrap(),
            original_source: None,
            inner_source_map: None,
            remove_original_source: false,
          }).boxed()
