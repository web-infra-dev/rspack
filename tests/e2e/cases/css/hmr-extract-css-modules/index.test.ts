...
// locals stay identical, so the update can only arrive through the
// miniCss manifest entry
...
// changed locals invalidate the proxy module and bubble to the entry,
// which re-applies the new mapping
