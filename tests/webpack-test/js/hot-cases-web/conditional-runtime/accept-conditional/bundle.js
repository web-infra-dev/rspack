...
it("should create a conditional import when accepted", done => {
	if (Math.random() < 0) new Worker(new URL(/* worker import */__webpack_require__.p + __webpack_require__.u("dep2_js-worker_js"), __webpack_require__.b));
	Promise.all(/*! import() */ [__webpack_require__.e("shared"), __webpack_require__.e("dep1_js-module_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./module */ "./module.js"))
		.then(module =>
			module.test(callback => {
				NEXT(__webpack_require__(/*! ../../update */ "../../update.js")(done, undefined, callback));
			}, done)
		)
		.catch(done);
});
