...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* ESM import */var _reexport__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./reexport */ "./reexport.js");


it("should auto-reexport an ES6 imported value on accept", function (done) {
	expect(_reexport__WEBPACK_IMPORTED_MODULE_0__.value).toBe(1);
	NEXT(
		__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
			expect(_reexport__WEBPACK_IMPORTED_MODULE_0__.value).toBe(2);
			done();
		})
	);
});
...
(() => {
__webpack_require__.h = () => ("42929ce1baedf54a")
})();
