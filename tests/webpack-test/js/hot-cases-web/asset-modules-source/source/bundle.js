...
it("should regenerate contenthash", function(done) {
	const value1 = new URL(/* asset import */__webpack_require__(/*! ./file.text */ "./file.text"), __webpack_require__.b);
	expect(/file\.[\da-f]{16}\.text/.test(value1.toString())).toBe(true);
	module.hot.accept(/*! ./file.text */ "./file.text", function(__WEBPACK_OUTDATED_DEPENDENCIES__) {
(function() {
		const value2 = new URL(/* asset import */__webpack_require__(/*! ./file.text */ "./file.text"), __webpack_require__.b);
...
(function (module, __unused_webpack_exports, __webpack_require__) {
"use strict";
module.exports = __webpack_require__.p + "assets/file.a16e7d3ee61b48e9.text";
...
(() => {
__webpack_require__.h = () => ("a9c70d9202d53f05")
})();
