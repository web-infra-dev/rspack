...
const moduleId = _a__WEBPACK_IMPORTED_MODULE_0__.id;

it("should abort when module is not accepted", done => {
	expect((0,_a__WEBPACK_IMPORTED_MODULE_0__["default"])()).toBe(1);
	expect((0,_a__WEBPACK_IMPORTED_MODULE_0__.getError)()).toBe(false);
	NEXT(
		__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
			expect((0,_a__WEBPACK_IMPORTED_MODULE_0__["default"])()).toBe(2);
			expect((0,_a__WEBPACK_IMPORTED_MODULE_0__.getError)()).toBe(true);
			NEXT(
				__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
					expect((0,_a__WEBPACK_IMPORTED_MODULE_0__["default"])()).toBe(2);
					expect((0,_a__WEBPACK_IMPORTED_MODULE_0__.getError)()).toBe(true);
					NEXT(
						__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
							expect((0,_a__WEBPACK_IMPORTED_MODULE_0__["default"])()).toBe(4);
							expect((0,_a__WEBPACK_IMPORTED_MODULE_0__.getError)()).toBe(false);
							done();
						})
					);
...
if (true) {
	module.hot.accept(/*! ./a */ "./a.js", function(){
