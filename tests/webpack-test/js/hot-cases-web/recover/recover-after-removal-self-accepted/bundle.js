...
it("should abort when module is not accepted", done => {
	expect(_module__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe("ok1-inner");
	NEXT(
		__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
			expect(_module__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe("ok2");
			NEXT(
				__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
					expect(_module__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe("ok3-inner");
					done();
				})
			);
		})
