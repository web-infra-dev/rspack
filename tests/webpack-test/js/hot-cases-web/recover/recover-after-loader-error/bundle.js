...
/* ESM import */var _loader_a__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./loader!./a */ "./loader.js!./a.js");


it("should abort when module is not accepted", (done) => {
	expect(_loader_a__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe(1);
	NEXT(__webpack_require__(/*! ../../update */ "../../update.js")(done, {
		...
		NEXT(__webpack_require__(/*! ../../update */ "../../update.js")(done, {
			...
			expect(_loader_a__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe(3);
			done();
		}));
	}));
});
...
if(true) {
	module.hot.accept(/*! ./loader!./a */ "./loader.js!./a.js", function(){
/* ESM import */_loader_a__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./loader!./a */ "./loader.js!./a.js");
...
(() => {
__webpack_require__.h = () => ("073bbf7decb4fea5")
})();
