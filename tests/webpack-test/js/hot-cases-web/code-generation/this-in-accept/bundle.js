...
it("should have correct this context in accept handler", (done) => {
	expect(_module__WEBPACK_IMPORTED_MODULE_0__["default"]).toEqual("ok1");
...
(() => {
            expect(_module__WEBPACK_IMPORTED_MODULE_0__["default"]).toEqual("ok2");
...
(() => {
__webpack_require__.h = () => ("1f62405d3d442c54")
})();
