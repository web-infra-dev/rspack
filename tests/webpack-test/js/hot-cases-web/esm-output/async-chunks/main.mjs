...
/* ESM import */var _update_esm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../update.esm */ "../../update.esm.js");

module.hot.accept([/*! ./async-module */ "./async-module.js", /*! ./lazy-module */ "./lazy-module.js"], function(){
...
it("should handle HMR with async chunks in ESM format", (done) => {
	...
	Promise.all([
		__webpack_require__.e(/*! import() */ "async-module_js").then(__webpack_require__.bind(__webpack_require__, /*! ./async-module */ "./async-module.js")),
		__webpack_require__.e(/*! import() */ "lazy-module_js").then(__webpack_require__.bind(__webpack_require__, /*! ./lazy-module */ "./lazy-module.js"))
	]).then(([asyncModule, lazyModule]) => {
		expect(asyncModule.message).toBe("Hello from async module!");
		expect(lazyModule.data.value).toBe(42);
				
		NEXT((0,_update_esm__WEBPACK_IMPORTED_MODULE_0__["default"])(done, true, () => {
...
it("should support dynamic imports with proper ESM chunk loading", (done) => {
	...
	__webpack_require__.e(/*! import() */ "async-module_js").then(__webpack_require__.bind(__webpack_require__, /*! ./async-module */ "./async-module.js")).then((module) => {
...
(() => {
__webpack_require__.h = () => ("17ffb79915137e20")
})();
