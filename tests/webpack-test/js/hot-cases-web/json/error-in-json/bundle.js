...
it("should be able to recover from json error", function(done) {
	expect(() => __webpack_require__(/*! ./data.json */ "./data.json")).toThrowError();
	module.hot.accept(/*! ./data.json */ "./data.json", function(__WEBPACK_OUTDATED_DEPENDENCIES__) {
(function() {
		expect(__webpack_require__(/*! ./data.json */ "./data.json")).toBe(42);
		done();
...
(() => {
__webpack_require__.h = () => ("ca20f60d434da55b")
})();
