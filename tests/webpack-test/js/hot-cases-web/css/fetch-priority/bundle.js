...
it("should work", async function (done) {
	const styles = await __webpack_require__.e(/*! import() */ "style_module_css", "high").then(__webpack_require__.bind(__webpack_require__, /*! ./style.module.css */ "./style.module.css"));

	expect(styles).toMatchObject({
		class: "_style_module_css-class"
	});

	module.hot.accept(/*! ./style.module.css */ "./style.module.css", function(__WEBPACK_OUTDATED_DEPENDENCIES__) {
(() => {
		__webpack_require__.e(/*! import() */ "style_module_css").then(__webpack_require__.bind(__webpack_require__, /*! ./style.module.css */ "./style.module.css")).then(styles => {
			expect(styles).toMatchObject({
...
(() => {
__webpack_require__.h = () => ("9884287e655f9c47")
})();
