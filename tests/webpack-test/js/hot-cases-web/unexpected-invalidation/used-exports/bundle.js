...
/* ESM import */var _module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module */ "./module.js");



it("should not invalidate subject in unrelated locations", done => {
	expect(_subject__WEBPACK_IMPORTED_MODULE_0__.ghi).toBe(42);
	expect(_module__WEBPACK_IMPORTED_MODULE_1__["default"]).toBe(40);
	module.hot.accept(/*! ./module */ "./module.js", function(__WEBPACK_OUTDATED_DEPENDENCIES__) {
/* ESM import */_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module */ "./module.js");
(() => {
		expect(_subject__WEBPACK_IMPORTED_MODULE_0__.ghi).toBe(42);
		expect(_module__WEBPACK_IMPORTED_MODULE_1__["default"]).toBe(41);
		done();
...
(() => {
__webpack_require__.h = () => ("9372743b95939be6")
})();
