...
it("should download the missing update chunk on import", () => {
	expect(_file__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe(1);
	return asyncNext().then(() => {
		return module.hot.check().then(() => {
			return Promise.all([
				__webpack_require__.e(/*! import() */ "chunk_js").then(__webpack_require__.bind(__webpack_require__, /*! ./chunk */ "./chunk.js")),
				__webpack_require__.e(/*! import() */ "unaffected-chunk_js").then(__webpack_require__.bind(__webpack_require__, /*! ./unaffected-chunk */ "./unaffected-chunk.js"))
			]).then(([chunk, unaffectedChunk]) => {
				expect(_file__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe(1);
				expect(chunk.default).toBe(10);
				expect(unaffectedChunk.default).toBe(10);
				return module.hot.apply().then(() => {
					expect(_file__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe(2);
