...
it("should dispose a chunk which is removed from bundle", (done) => {
	var m1 = __webpack_require__(/*! ./module */ "./module.js");
	m1.default.then((x1) => {
		expect(x1.default).toEqual("version a1");
		NEXT(__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
			var m2 = __webpack_require__(/*! ./module */ "./module.js");
			m2.default.then((x2) => {
				expect(x2.default).toEqual("version b1");
				NEXT(__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
					var m3 = __webpack_require__(/*! ./module */ "./module.js");
					m3.default.then((x3) => {
						expect(x3.default).toEqual("version b2");
						NEXT(__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
							var m4 = __webpack_require__(/*! ./module */ "./module.js");
							m4.default.then((x4) => {
...
(() => {
__webpack_require__.h = () => ("27ba10164ac0fe90")
})();
