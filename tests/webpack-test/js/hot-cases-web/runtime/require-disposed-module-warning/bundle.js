...
"../../../helpers/expectWarningFactory.js": 
/*!************************************************!*\
  !*** ../../../helpers/expectWarningFactory.js ***!
  \************************************************/
(function (module) {
...
const expectWarning = __webpack_require__(/*! ../../../helpers/expectWarningFactory */ "../../../helpers/expectWarningFactory.js")();
const getInner = __webpack_require__(/*! ./module */ "./module.js");
...
it("should print correct warning messages when a disposed module is required", done => {
	NEXT(
		__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
			...
			const getInnerUpdated = __webpack_require__(/*! ./module */ "./module.js");
			getInnerUpdated();
			expectWarning();
			done();
		})
