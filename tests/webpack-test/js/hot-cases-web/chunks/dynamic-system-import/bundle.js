...
"./. lazy recursive ^\\.\\/chunk.*$": 
/*!*************************************************************************************************************************************************!*\
  !*** /Users/zackjackson/rspack/tests/webpack-test/hotCases/chunks/dynamic-system-import|lazy|/^\.\/chunk.*$/|groupOptions: {}|namespace object ***!
  \*************************************************************************************************************************************************/
...
webpackAsyncContext.id = "./. lazy recursive ^\\.\\/chunk.*$";
...
it("should import a changed chunk (dynamic import)", function(done) {
	function load(name) {
		return __webpack_require__(/*! . */ "./. lazy recursive ^\\.\\/chunk.*$")("./chunk" + name);
	}
	load(1).then((chunk) => {
		expect(chunk.value).toBe(1);
		NEXT(__webpack_require__(/*! ../../update */ "../../update.js")(done, true, () => {
...
(() => {
__webpack_require__.h = () => ("8499240cff4428be")
})();
