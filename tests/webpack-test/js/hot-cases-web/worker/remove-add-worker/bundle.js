...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* ESM import */var _compute__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./compute */ "./compute.js");
...
it("should support adding and removing runtimes", async () => {
	expect(await (0,_compute__WEBPACK_IMPORTED_MODULE_0__["default"])()).toBe(42);
	await update();
	expect(await (0,_compute__WEBPACK_IMPORTED_MODULE_0__["default"])()).toBe(42);
	await update();
	expect(await (0,_compute__WEBPACK_IMPORTED_MODULE_0__["default"])()).toBe(42);
...
module.hot.accept(/*! ./compute */ "./compute.js", function(){
/* ESM import */_compute__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./compute */ "./compute.js");
...
(() => {
__webpack_require__.h = () => ("91069b65b4543982")
})();
