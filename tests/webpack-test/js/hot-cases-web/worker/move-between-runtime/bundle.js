...
it("should support hot module replacement in WebWorkers", async () => {
	const a = new Worker(new URL(/* worker import */__webpack_require__.p + __webpack_require__.u("workerA_js"), __webpack_require__.b));
	const b = new Worker(new URL(/* worker import */__webpack_require__.p + __webpack_require__.u("workerB_js"), __webpack_require__.b));
	for (let i = 0; i < 7; i++) {
		await update();
		await next(a);
		await next(b);
