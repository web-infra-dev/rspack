...
self.onmessage = async ({ data: msg }) => {
	try {
		switch (msg) {
			...
			case "test":
				if (_module__WEBPACK_IMPORTED_MODULE_0__["default"] === 42 && counter === 4) {
					self.postMessage("done");
					break;
				}
				if (_module__WEBPACK_IMPORTED_MODULE_0__["default"] !== counter)
					throw new Error(`module (${_module__WEBPACK_IMPORTED_MODULE_0__["default"]}) should be ${counter}`);
				counter++;
...
__webpack_require__.hmrF = function () {
            return "69a99378f47a64dc." + __webpack_require__.h() + ".hot-update.json";
         };
