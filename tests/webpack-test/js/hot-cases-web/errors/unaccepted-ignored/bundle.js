...
/* ESM import */var _c__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./c */ "./c.js");


function get() {
	return _c__WEBPACK_IMPORTED_MODULE_0__["default"];
}

if(true) {
	module.hot.accept(/*! ./c */ "./c.js", function(){
/* ESM import */_c__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./c */ "./c.js");
...
it("should ignore unaccepted module updates", (done) => {
	function waitForUpdate(fn) {
		NEXT(__webpack_require__(/*! ../../update */ "../../update.js")(done, options, fn));
	}

	expect(_a__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe(2);
	expect((0,_b__WEBPACK_IMPORTED_MODULE_1__["default"])()).toBe(1);
	waitForUpdate(() => {
		expect(_a__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe(2);
		expect((0,_b__WEBPACK_IMPORTED_MODULE_1__["default"])()).toBe(1);
		waitForUpdate(() => {
			expect(_a__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe(2);
			expect((0,_b__WEBPACK_IMPORTED_MODULE_1__["default"])()).toBe(2);
			waitForUpdate(() => {
				expect(_a__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe(2);
				expect((0,_b__WEBPACK_IMPORTED_MODULE_1__["default"])()).toBe(3);
				done();
			});
		});
	});
...
(() => {
__webpack_require__.h = () => ("a3732ceb7137e5f9")
})();
