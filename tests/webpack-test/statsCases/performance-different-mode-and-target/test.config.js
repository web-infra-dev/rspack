...
module.exports = {
	validate(stats, error, actual) {
		...
		expect(diffStats(actual, path.basename(__dirname)))
			...
			@@ -1,1 +1,1 @@
			- asset warning.pro-web.js XX KiB [emitted] (name: main)
			+ asset warning.pro-web.js XX KiB [emitted] [big] (name: main)
			@@ -4,2 +4,4 @@
			...
			@@ -16,1 +20,1 @@
			- asset warning.pro-webworker.js XX KiB [emitted] (name: main)
			+ asset warning.pro-webworker.js XX KiB [emitted] [big] (name: main)
			@@ -19,2 +23,4 @@
			- WARNING in ⚠ asset size limit: The following asset(s) exceed the recommended size limit (XX KiB). This can impact web performance.Assets:
			...
			+ webpack x.x.x compiled successfully in X ms
			@@ -43,1 +51,1 @@
			- asset no-warning.dev-web-with-limit-set.js XX MiB [emitted] (name: main)
			+ asset no-warning.dev-web-with-limit-set.js XX MiB [emitted] [big] (name: main)
			@@ -45,1 +53,1 @@
			- Rspack x.x.x compiled successfully in X.XX
			+ webpack x.x.x compiled successfully in X ms
			@@ -47,1 +55,1 @@
			- asset warning.pro-node-with-hints-set.js XX KiB [emitted] (name: main)
			+ asset warning.pro-node-with-hints-set.js XX KiB [emitted] [big] (name: main)
			@@ -50,2 +58,4 @@
			- WARNING in ⚠ asset size limit: The following asset(s) exceed the recommended size limit (XX KiB). This can impact web performance.Assets:
