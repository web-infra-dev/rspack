...
let build = 0;
let staleCompilation: Compilation | null = null;
let staleRead: ReturnType<typeof capture> | null = null;
let midMakeReads: {
  modules: ReturnType<typeof capture>;
  builtModules: ReturnType<typeof capture>;
} | null = null;

function capture(read: () => number) {
  try {
