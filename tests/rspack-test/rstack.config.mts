  ...
  const sharedConfig = defineProject({
    ...
    resolve: {
      alias: {
        ...
        slash: path.join(import.meta.dirname, '../../scripts/test/slash.cjs'),
    ...
    env: {
      ...
      __TEST_PATH__: import.meta.dirname,
      __TEST_FIXTURES_PATH__: path.resolve(import.meta.dirname, 'fixtures'),
      __TEST_DIST_PATH__: path.resolve(import.meta.dirname, 'js'),
      __ROOT_PATH__: root,
