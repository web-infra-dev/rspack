        ...
        Object {
          "errors": Array [
            Object {
              ...
              "message": "  × test push",
              "moduleTrace": Array [],
              "stack": "Error: test push    at Object.fn (<ROOT>/tests/rspack-test/errorCases/error-write.mjs<LINE_COL>)    at next (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at AsyncSeriesHook.callAsyncStageRange (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>    at new Promise (<anonymous>)    at AsyncSeriesHook.promiseStageRange (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at QueriedHook.promise (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>    at last.function (<RSPACK_ROOT>/dist/index.js<LINE_COL>)",
            },
            Object {
              "code": "Error",
              "message": "  × test push 2",
        ...
        Object {
          "errors": Array [
            Object {
              ...
              "message": "  × error 1",
              "moduleTrace": Array [],
              "stack": "Error: error 1    at Object.fn (<ROOT>/tests/rspack-test/errorCases/error-write.mjs<LINE_COL>)    at next (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at AsyncSeriesHook.callAsyncStageRange (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>    at new Promise (<anonymous>)    at AsyncSeriesHook.promiseStageRange (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at QueriedHook.promise (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>    at last.function (<RSPACK_ROOT>/dist/index.js<LINE_COL>)",
            },
          ],
          "warnings": Array [],
        }
        ...
        Object {
          "errors": Array [
            ...
            Object {
              ...
              "message": "  × error 2",
              "moduleTrace": Array [],
              "stack": "Error: error 2    at Object.fn (<ROOT>/tests/rspack-test/errorCases/error-write.mjs<LINE_COL>)    at next (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at AsyncSeriesHook.callAsyncStageRange (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>    at new Promise (<anonymous>)    at AsyncSeriesHook.promiseStageRange (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at QueriedHook.promise (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>    at last.function (<RSPACK_ROOT>/dist/index.js<LINE_COL>)",
            },
          ],
          "warnings": Array [],
        }
        ...
        Object {
          "errors": Array [
            Object {
              ...
              "moduleTrace": Array [],
              "stack": "Error: test unshift    at Object.fn (<ROOT>/tests/rspack-test/errorCases/error-write.mjs<LINE_COL>)    at next (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at AsyncSeriesHook.callAsyncStageRange (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>    at new Promise (<anonymous>)    at AsyncSeriesHook.promiseStageRange (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at QueriedHook.promise (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>    at last.function (<RSPACK_ROOT>/dist/index.js<LINE_COL>)",
            },
          ],
          "warnings": Array [],
        }
        ...
        Object {
          "errors": Array [
            Object {
              ...
              "message": "  × test splice",
              "moduleTrace": Array [],
              "stack": "Error: test splice    at Object.fn (<ROOT>/tests/rspack-test/errorCases/error-write.mjs<LINE_COL>)    at next (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at AsyncSeriesHook.callAsyncStageRange (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>    at new Promise (<anonymous>)    at AsyncSeriesHook.promiseStageRange (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at QueriedHook.promise (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>    at last.function (<RSPACK_ROOT>/dist/index.js<LINE_COL>)",
            },
          ],
          "warnings": Array [],
        }
