		...
		async check(diagnostics) {
			...
			Object {
			  "errors": Array [
			    Object {
			      "loc": "4:8-19",
			      "message": "  × Module not found: Can't resolve './missing' in '<TEST_TOOLS_ROOT>/fixtures/errors'   ╭─[4:0] 2 │  3 │ // on line 4 4 │ require(\\"./missing\\");   · ──────────────────── 5 │  6 │    ╰────",
			    ...
			    Object {
			      "loc": "12:17-33",
			      "message": "  × Module not found: Can't resolve './dir/missing2' in '<TEST_TOOLS_ROOT>/fixtures/errors'    ╭─[12:9] 10 │  11 │ // on line 12 char 10 12 │          require(\\"./dir/missing2\\");    ·          ─────────────────────────    ╰────",
			      "moduleId": "./missingFile.js",
			      "moduleIdentifier": "<TEST_TOOLS_ROOT>/fixtures/errors/missingFile.js",
			      "moduleName": "./missingFile.js",
			      "moduleTrace": Array [],
