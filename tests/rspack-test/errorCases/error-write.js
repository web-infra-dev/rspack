			...
			Object {
			  "errors": Array [
			    Object {
			      ...
			      "message": "  × error 1",
			      "moduleTrace": Array [],
			      "stack": "Error: error 1    at <TEST_TOOLS_ROOT>/errorCases/error-write.js<LINE_COL>    at Object.fn (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at next (<ROOT>/node_modules/<PNPM_INNER>/@rspack/lite-tapable/dist/index.js<LINE_COL>)    at AsyncSeriesHook.callAsyncStageRange (<ROOT>/node_modules/<PNPM_INNER>/@rspack/lite-tapable/dist/index.js<LINE_COL>)    at AsyncSeriesHook.callAsync (<ROOT>/node_modules/<PNPM_INNER>/@rspack/lite-tapable/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>",
			    },
			  ],
			  "warnings": Array [],
			}
			...
			Object {
			  "errors": Array [
			    ...
			    Object {
			      ...
			      "message": "  × error 2",
			      "moduleTrace": Array [],
			      "stack": "Error: error 2    at <TEST_TOOLS_ROOT>/errorCases/error-write.js<LINE_COL>    at Object.fn (<RSPACK_ROOT>/dist/index.js<LINE_COL>)    at next (<ROOT>/node_modules/<PNPM_INNER>/@rspack/lite-tapable/dist/index.js<LINE_COL>)    at AsyncSeriesHook.callAsyncStageRange (<ROOT>/node_modules/<PNPM_INNER>/@rspack/lite-tapable/dist/index.js<LINE_COL>)    at AsyncSeriesHook.callAsync (<ROOT>/node_modules/<PNPM_INNER>/@rspack/lite-tapable/dist/index.js<LINE_COL>)    at <RSPACK_ROOT>/dist/index.js<LINE_COL>",
			    },
			  ],
			  "warnings": Array [],
			}
