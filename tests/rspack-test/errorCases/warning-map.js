		...
		Array [
		  ...
		  "stack": undefined,
		    ...
		    module: NormalModule {
		      ...
		      buildMeta: Object {},
		      context: <TEST_TOOLS_ROOT>/fixtures/errors,
		      factoryMeta: Object {},
		      layer: undefined,
		      loaders: Array [],
		      matchResource: undefined,
		      rawRequest: ./require.main.require,
		      request: <TEST_TOOLS_ROOT>/fixtures/errors/require.main.require.js,
		      resource: <TEST_TOOLS_ROOT>/fixtures/errors/require.main.require.js,
		      resourceResolveData: ReadonlyResourceData {
		        fragment: ,
		        path: <TEST_TOOLS_ROOT>/fixtures/errors/require.main.require.js,
		        query: ,
		        resource: <TEST_TOOLS_ROOT>/fixtures/errors/require.main.require.js,
		      },
		      ...
		      useSourceMap: false,
		      userRequest: <TEST_TOOLS_ROOT>/fixtures/errors/require.main.require.js,
		    },
