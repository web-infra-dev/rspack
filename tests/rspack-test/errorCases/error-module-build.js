			...
			Object {
			  "errors": Array [
			    Object {
			      ...
			      "message": "  × Module parse failed:  ╰─▶   × JavaScript parse error: Unexpected token ';' as property key         ╭─[2:12]       1 │ window.foo = {       2 │   bar: true,;         ·             ─       3 │ };         ╰────        help:         You may need an appropriate loader to handle this file type.",
