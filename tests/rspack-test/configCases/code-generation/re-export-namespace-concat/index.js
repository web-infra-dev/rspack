...
it("should use/preserve accessor form for import object and namespaces", function () {
	...
	const requireExpression = globalThis.__RSPACK_TEST_RUNTIME_MODE_RSPACK
		? "__rspack_context.r"
		: "__webpack_require__";
	expectSourceToMatch(source, `${regexEscape(`const ww = (${requireExpression}(`)}\\d+${regexEscape(')/* .obj1.bing.bang */.obj1.bing.bang);')}`);
	expectSourceToMatch(source, `${regexEscape(`const xx = (${requireExpression}(`)}\\d+${regexEscape(')/* .obj1.pip.pop */.obj1.pip.pop)();')}`);
	expectSourceToMatch(source, `${regexEscape(`const yy = (${requireExpression}(`)}\\d+${regexEscape(')/* .m_2.m_1.obj1.tip.top */.a.a.obj1.tip.top)();')}`);
