...
import * as link from "./link.module.css?link";
...
it("should accept parser exportType link", () => {
  expect(Object.keys(link)).not.toContain("default");
  expect(link.link).toBe("link.module_module_css-link");
});
