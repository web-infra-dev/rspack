...
it('should prefetch and preload child chunks on chunk load', () => {
  ...
  const promise = import(/* webpackChunkName: "chunk1" */ './chunk1.mjs');
  ...
  return promise.then(() => {
    ...
    const promise2 = import(/* webpackChunkName: "chunk1" */ './chunk1.mjs');
    ...
    return promise3.then(() => {
      ...
      const promise4 = import(
        /* webpackChunkName: "chunk1-css" */ './chunk1.css'
      );
      ...
      const promise5 = import(
        /* webpackChunkName: "chunk2-css", webpackPrefetch: true */ './chunk2.css'
      );
