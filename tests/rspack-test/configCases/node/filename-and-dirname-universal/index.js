...
it("should work", () => {
	if (isBrowser) {
		...
		// We can't handle `parser.hooks.typeof` and `parser.hooks.evaluateTypeof` for
		// `import.meta.dirname` and `import.meta.filename` because they may not exist
		// when code is running.
		expect(import.meta.dirname).toBe(
