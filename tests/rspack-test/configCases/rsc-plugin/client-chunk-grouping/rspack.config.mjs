...
const pageOnePath = path.join(import.meta.dirname, 'src/pages/PageOne.js');
const pageTwoPath = path.join(import.meta.dirname, 'src/pages/PageTwo.js');
const clientPaths = {
  pageOneA: path.join(import.meta.dirname, 'src/clients/PageOneClientA.js'),
  pageOneB: path.join(import.meta.dirname, 'src/clients/PageOneClientB.js'),
  pageOneDynamic: path.join(
    import.meta.dirname,
    'src/clients/PageOneDynamicClient.js',
  ),
  pageTwo: path.join(import.meta.dirname, 'src/clients/PageTwoClient.js'),
  rootA: path.join(import.meta.dirname, 'src/clients/RootOnlyA.js'),
  rootB: path.join(import.meta.dirname, 'src/clients/RootOnlyB.js'),
  sharedAcrossPages: path.join(
    import.meta.dirname,
    'src/clients/SharedAcrossPages.js',
  ),
  sharedRootAndPage: path.join(
    import.meta.dirname,
    'src/clients/SharedRootAndPage.js',
  ),
