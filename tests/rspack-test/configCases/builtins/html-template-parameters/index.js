...
it("should inject htmlRspackPlugin.tags.headTags", () => {
	expect(htmlContent).toContain(`<title>i am title</title><meta content="meta-value" name="meta-name"><link href="http://cdn.com/favicon.ico" rel="icon"><script defer src="http://cdn.com/bundle0.js"></script><link data-rspack=":mini-css-chunk-main" href="http://cdn.com/main.css" rel="stylesheet">`);
});
