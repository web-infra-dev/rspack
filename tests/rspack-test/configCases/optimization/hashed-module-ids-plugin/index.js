...
it("should produce the same id for the same module and different ids for different modules", function () {
	var id1 = require("./files/file1.js");
	var id2 = require("./files/file2.js");
	expect(id1).toBe(require("./files/file1.js"));
	expect(id2).toBe(require("./files/file2.js"));
