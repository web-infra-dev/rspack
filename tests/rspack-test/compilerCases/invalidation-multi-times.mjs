		...
		try {
			await new Promise((resolve, reject) => {
				...
				compiler.watch({}, (err) => {
					...
					if (firstRun) {
						firstRun = false;
						compiler.watching.invalidateWithChangesAndRemovals(new Set([path.resolve(import.meta.dirname, "../fixtures/a.js")]));
						compiler.watching.invalidateWithChangesAndRemovals(new Set([path.resolve(import.meta.dirname, "../fixtures/b.js")]));
						setTimeout(() => {
							resolve();
						}, 2000)
					}
