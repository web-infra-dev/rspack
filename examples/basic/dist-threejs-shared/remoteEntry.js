...
(() => {
  ...
  \************************************************************************************************************************************/
		...
		"webpack/container/entry/threejs_app":
			/*!***********************!*\
  !*** container entry ***!
  \***********************/
  ...
  \*************************************************************************************************************************************************************/
			...
			moduleMap: {
				"./Scene": () => {
					return Promise.all([
						...
						__webpack_require__.e("threejs-app_src_main_js")
					]).then(
						() => () =>
							__webpack_require__(
								/*! ./threejs-app/src/main.js */ "./threejs-app/src/main.js"
							)
					);
				},
				"./Materials": () => {
					return Promise.all([
						...
						__webpack_require__.e("threejs-app_src_materials_js")
					]).then(
						() => () =>
							__webpack_require__(
								/*! ./threejs-app/src/materials.js */ "./threejs-app/src/materials.js"
							)
					);
				},
				"./Geometries": () => {
					return Promise.all([
						...
						__webpack_require__.e("threejs-app_src_geometries_js")
					]).then(
						() => () =>
							__webpack_require__(
								/*! ./threejs-app/src/geometries.js */ "./threejs-app/src/geometries.js"
							)
					);
				}
			},
	...
	(() => {
		...
		var installedChunks = { threejs_app: 0 };
	...
	threejs_app = __webpack_exports__;
})();
