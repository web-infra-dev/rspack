...
(self["webpackChunkrspack_basic_example"] =
	...
	{
		"../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/loaders/RGBELoader.js":
			/*!****************************************************************************************************!*\
  !*** ../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/loaders/RGBELoader.js ***!
  \****************************************************************************************************/
			function (
				...
				__webpack_require__.d(__webpack_exports__, {
					RGBELoader: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three-rgbe-loader.RGBELoader"] */ RGBELoader
				});
					...
					parse(buffer) {
							...
							rgbe_error = function (rgbe_error_code, msg) {
								switch (rgbe_error_code) {
									...
									case rgbe_memory_error:
										throw new Error(
											"THREE.RGBELoader: Memory Error: " + (msg || "")
										);
								}
							},
						...
						const RGBEByteToRGBHalf = function (
							...
							destArray[destOffset + 0] =
								three__WEBPACK_IMPORTED_MODULE_0__.DataUtils.toHalfFloat(
							...
							destArray[destOffset + 3] =
								three__WEBPACK_IMPORTED_MODULE_0__.DataUtils.toHalfFloat(1);
						};
