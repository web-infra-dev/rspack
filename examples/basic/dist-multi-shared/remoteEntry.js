...
(() => {
  ...
  \************************************************************************************************************************************/
		...
		"webpack/container/entry/multi_app_three":
			/*!***********************!*\
  !*** container entry ***!
  \***********************/
  ...
  \*************************************************************************************************************************************************************/
		...
		if (!__webpack_require__.federation) {
			__webpack_require__.federation = {
				chunkMatcher: function (chunkId) {
					return !/^webpack_sharing_consume_default_((materials_shared\-three_materia|scene\-utils_shared\-three_scene\-uti)ls_js|three_three)$/.test(
						chunkId
					);
				},
				rootOutputDir: ""
	...
	(() => {
		__webpack_require__.consumesLoadingData = {
			chunkMapping: {
				...
				"webpack_sharing_consume_default_scene-utils_shared-three_scene-utils_js":
					[
						"webpack/sharing/consume/default/scene-utils/./shared-three/scene-utils.js"
					],
				"webpack_sharing_consume_default_materials_shared-three_materials_js": [
			...
			moduleMap: {
				"./App1": () => {
					return Promise.all([
						...
						__webpack_require__.e("app1-viz_src_index_js")
					]).then(
						() => () =>
							__webpack_require__(
				...
				"./App2": () => {
					return Promise.all([
						...
						__webpack_require__.e("app2-editor_src_index_js")
					]).then(
						() => () =>
							__webpack_require__(
				...
				"./App3": () => {
					return Promise.all([
						...
						__webpack_require__.e("app3-game_src_index_js")
					]).then(
						() => () =>
							__webpack_require__(
	...
	(() => {
		...
		var installedChunks = { multi_app_three: 0 };
		...
		__webpack_require__.f.j = function (chunkId, promises) {
			...
			if (installedChunkData !== 0) {
				...
				if (installedChunkData) {
					...
					if (
						!/^webpack_sharing_consume_default_((materials_shared\-three_materia|scene\-utils_shared\-three_scene\-uti)ls_js|three_three)$/.test(
							chunkId
						)
					) {
	...
	multi_app_three = __webpack_exports__;
})();
