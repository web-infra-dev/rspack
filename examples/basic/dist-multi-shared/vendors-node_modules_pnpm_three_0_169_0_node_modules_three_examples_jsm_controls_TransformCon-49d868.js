...
(self["webpackChunkrspack_basic_example"] =
	...
	[
		"vendors-node_modules_pnpm_three_0_169_0_node_modules_three_examples_jsm_controls_TransformCon-49d868"
	],
	{
		"../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/controls/TransformControls.js":
			/*!************************************************************************************************************!*\
  !*** ../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/controls/TransformControls.js ***!
  \************************************************************************************************************/
			function (
				...
				__webpack_require__.d(__webpack_exports__, {
					TransformControls: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/controls/TransformControls.js.TransformControls"] */ TransformControls,
					TransformControlsGizmo: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/controls/TransformControls.js.TransformControlsGizmo"] */ TransformControlsGizmo,
					TransformControlsPlane: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/controls/TransformControls.js.TransformControlsPlane"] */ TransformControlsPlane
				});
				...
				class TransformControls extends three__WEBPACK_IMPORTED_MODULE_0__.Controls {
					constructor(camera, domElement = null) {
						...
						const worldPositionStart =
							new three__WEBPACK_IMPORTED_MODULE_0__.Vector3();
						const worldQuaternion =
							new three__WEBPACK_IMPORTED_MODULE_0__.Quaternion();
						const worldQuaternionStart =
							new three__WEBPACK_IMPORTED_MODULE_0__.Quaternion();
				...
				const _alignVector = new three__WEBPACK_IMPORTED_MODULE_0__.Vector3(
					0,
					1,
					0
				);
				const _zeroVector = new three__WEBPACK_IMPORTED_MODULE_0__.Vector3(
					0,
					0,
					0
				);
				const _lookAtMatrix = new three__WEBPACK_IMPORTED_MODULE_0__.Matrix4();
				const _tempQuaternion2 =
					new three__WEBPACK_IMPORTED_MODULE_0__.Quaternion();
				const _identityQuaternion =
					new three__WEBPACK_IMPORTED_MODULE_0__.Quaternion();
				...
				class TransformControlsRoot extends three__WEBPACK_IMPORTED_MODULE_0__.Object3D {
					...
					updateMatrixWorld(force) {
						...
						if (controls.object !== undefined) {
							...
							controls._parentQuaternionInv
								.copy(controls._parentQuaternion)
								.invert();
							controls._worldQuaternionInv
								.copy(controls.worldQuaternion)
								.invert();
						}
				...
				class TransformControlsGizmo extends three__WEBPACK_IMPORTED_MODULE_0__.Object3D {
					constructor() {
						...
						function CircleGeometry(radius, arc) {
							const geometry =
								new three__WEBPACK_IMPORTED_MODULE_0__.TorusGeometry(
									radius,
									0.0075,
									3,
									64,
						...
						const gizmoTranslate = {
							...
							XYZ: [
								[
									new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
										new three__WEBPACK_IMPORTED_MODULE_0__.OctahedronGeometry(
											0.1,
											0
										),
						...
						const helperTranslate = {
							...
							DELTA: [
								[
									new three__WEBPACK_IMPORTED_MODULE_0__.Line(
						...
						const pickerRotate = {
							XYZE: [
								[
									new three__WEBPACK_IMPORTED_MODULE_0__.Mesh(
										new three__WEBPACK_IMPORTED_MODULE_0__.SphereGeometry(
											0.25,
											10,
											8
										),
					...
					updateMatrixWorld(force) {
						...
						for (let i = 0; i < handles.length; i++) {
							...
							handle.scale
								.set(1, 1, 1)
								.multiplyScalar((factor * this.size) / 4);
				...
				class TransformControlsPlane extends three__WEBPACK_IMPORTED_MODULE_0__.Mesh {
					constructor() {
						super(
							new three__WEBPACK_IMPORTED_MODULE_0__.PlaneGeometry(
								100000,
								100000,
								2,
								2
