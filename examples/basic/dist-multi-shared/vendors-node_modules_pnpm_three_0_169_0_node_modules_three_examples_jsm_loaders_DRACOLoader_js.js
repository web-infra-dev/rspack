...
(self["webpackChunkrspack_basic_example"] =
	...
	{
		"../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/loaders/DRACOLoader.js":
			/*!*****************************************************************************************************!*\
  !*** ../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/loaders/DRACOLoader.js ***!
  \*****************************************************************************************************/
			function (
				...
				__webpack_require__.d(__webpack_exports__, {
					DRACOLoader: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/loaders/DRACOLoader.js.DRACOLoader"] */ DRACOLoader
				});
				...
				class DRACOLoader extends three__WEBPACK_IMPORTED_MODULE_0__.Loader {
					...
					decodeDracoFile(
						...
						attributeIDs,
						attributeTypes,
						vertexColorSpace = three__WEBPACK_IMPORTED_MODULE_0__.LinearSRGBColorSpace,
						onError = () => {}
					) {
						const taskConfig = {
					...
					_assignVertexColorSpace(attribute, inputColorSpace) {
						...
						for (let i = 0, il = attribute.count; i < il; i++) {
							...
							three__WEBPACK_IMPORTED_MODULE_0__.ColorManagement.toWorkingColorSpace(
								_color,
								three__WEBPACK_IMPORTED_MODULE_0__.SRGBColorSpace
							);
