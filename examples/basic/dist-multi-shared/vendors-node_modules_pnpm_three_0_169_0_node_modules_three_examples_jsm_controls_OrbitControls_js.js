  ...
  \********************************************************************************************************/
			function (
				...
				__webpack_require__.d(__webpack_exports__, {
					OrbitControls: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/controls/OrbitControls.js.OrbitControls"] */ OrbitControls
				});
				...
				const _TILT_LIMIT = Math.cos(
					70 * three__WEBPACK_IMPORTED_MODULE_0__.MathUtils.DEG2RAD
				);
				...
				class OrbitControls extends three__WEBPACK_IMPORTED_MODULE_0__.Controls {
					constructor(object, domElement = null) {
						...
						this._quat =
							new three__WEBPACK_IMPORTED_MODULE_0__.Quaternion().setFromUnitVectors(
								object.up,
						...
						this._spherical =
							new three__WEBPACK_IMPORTED_MODULE_0__.Spherical();
					...
					update(deltaTime = null) {
						...
						if (
							zoomChanged ||
							this._lastPosition.distanceToSquared(this.object.position) >
								_EPS ||
							8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) >
								_EPS ||
