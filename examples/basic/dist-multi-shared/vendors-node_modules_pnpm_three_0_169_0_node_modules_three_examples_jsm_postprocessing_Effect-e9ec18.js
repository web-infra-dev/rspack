			...
			function (
				...
				__webpack_require__.d(__webpack_exports__, {
					EffectComposer: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/postprocessing/EffectComposer.js.EffectComposer"] */ EffectComposer
				});
			...
			function (
				...
				__webpack_require__.d(__webpack_exports__, {
					ClearMaskPass: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/postprocessing/EffectComposer.js.ClearMaskPass"] */ ClearMaskPass,
					MaskPass: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/postprocessing/EffectComposer.js.MaskPass"] */ MaskPass
				});
			...
			function (
				...
				__webpack_require__.d(__webpack_exports__, {
					ShaderPass: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/postprocessing/EffectComposer.js.ShaderPass"] */ ShaderPass
				});
				/* ESM import */ var three__WEBPACK_IMPORTED_MODULE_0__ =
					/* #__PURE__ */ __webpack_require__(
						/*! three */ "webpack/sharing/consume/default/three/three"
			...
			function (
				...
				__webpack_require__.d(__webpack_exports__, {
					CopyShader: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/postprocessing/EffectComposer.js.CopyShader"] */ CopyShader
				});
				/**
