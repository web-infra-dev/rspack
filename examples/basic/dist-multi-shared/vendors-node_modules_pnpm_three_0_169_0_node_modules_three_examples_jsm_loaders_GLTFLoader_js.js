...
(self["webpackChunkrspack_basic_example"] =
	...
	{
		"../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/loaders/GLTFLoader.js":
			/*!****************************************************************************************************!*\
  !*** ../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/loaders/GLTFLoader.js ***!
  \****************************************************************************************************/
			function (
				...
				__webpack_require__.d(__webpack_exports__, {
					GLTFLoader: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/loaders/GLTFLoader.js.GLTFLoader"] */ GLTFLoader
				});
				/* ESM import */ var three__WEBPACK_IMPORTED_MODULE_0__ =
					/* #__PURE__ */ __webpack_require__(
						/*! three */ "webpack/sharing/consume/default/three/three"
					);
				/* ESM import */ var _utils_BufferGeometryUtils_js__WEBPACK_IMPORTED_MODULE_1__ =
					/* #__PURE__ */ __webpack_require__(
						/*! ../utils/BufferGeometryUtils.js */ "../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/utils/BufferGeometryUtils.js"
					);
				...
				class GLTFLoader extends three__WEBPACK_IMPORTED_MODULE_0__.Loader {
					...
					load(url, onLoad, onProgress, onError) {
						...
						if (this.resourcePath !== "") {
							...
							const relativeUrl =
								three__WEBPACK_IMPORTED_MODULE_0__.LoaderUtils.extractUrlBase(
									url
								);
							resourcePath =
								three__WEBPACK_IMPORTED_MODULE_0__.LoaderUtils.resolveURL(
									relativeUrl,
									this.path
								);
						} else {
				...
				class GLTFLightsExtension {
					...
					_loadLight(lightIndex) {
						...
						switch (lightDef.type) {
							...
							case "point":
								lightNode = new three__WEBPACK_IMPORTED_MODULE_0__.PointLight(
									color
								);
							...
							case "spot":
								lightNode = new three__WEBPACK_IMPORTED_MODULE_0__.SpotLight(
									color
								);
								lightNode.distance = range;
				...
				class GLTFMaterialsUnlitExtension {
					...
					extendParams(materialParams, materialDef, parser) {
						...
						materialParams.color = new three__WEBPACK_IMPORTED_MODULE_0__.Color(
							1.0,
							1.0,
							1.0
						);
						...
						if (extension.clearcoatNormalTexture !== undefined) {
							...
							if (extension.clearcoatNormalTexture.scale !== undefined) {
								...
								materialParams.clearcoatNormalScale =
									new three__WEBPACK_IMPORTED_MODULE_0__.Vector2(scale, scale);
							}
						}
				...
				class GLTFMaterialsSheenExtension {
					...
					extendMaterialParams(materialIndex, materialParams) {
						...
						materialParams.sheenColor =
							new three__WEBPACK_IMPORTED_MODULE_0__.Color(0, 0, 0);
				...
				class GLTFMaterialsVolumeExtension {
					...
					extendMaterialParams(materialIndex, materialParams) {
						...
						materialParams.attenuationColor =
							new three__WEBPACK_IMPORTED_MODULE_0__.Color().setRGB(
								colorArray[0],
								colorArray[1],
								colorArray[2],
								three__WEBPACK_IMPORTED_MODULE_0__.LinearSRGBColorSpace
				...
				class GLTFMaterialsIorExtension {
					...
					extendMaterialParams(materialIndex, materialParams) {
						...
						materialParams.ior =
							extension.ior !== undefined ? extension.ior : 1.5;
					...
					createNodeMesh(nodeIndex) {
						...
						return Promise.all(pending).then(results => {
							...
							for (const mesh of meshes) {
								...
								const instancedMesh =
									new three__WEBPACK_IMPORTED_MODULE_0__.InstancedMesh(
										mesh.geometry,
										mesh.material,
										count
									);
								...
								for (const attributeName in attributes) {
									if (attributeName === "_COLOR_0") {
										...
										instancedMesh.instanceColor =
											new three__WEBPACK_IMPORTED_MODULE_0__.InstancedBufferAttribute(
												attr.array,
												attr.itemSize,
												attr.normalized
											);
								...
								// Just in case
								three__WEBPACK_IMPORTED_MODULE_0__.Object3D.prototype.copy.call(
									instancedMesh,
									mesh
								);
				...
				class GLTFParser {
					constructor(json = {}, options = {}) {
						...
						if (typeof navigator !== "undefined") {
							...
							isSafari =
								/^((?!chrome|android).)*safari/i.test(userAgent) === true;
						...
						if (
							...
							this.textureLoader =
								new three__WEBPACK_IMPORTED_MODULE_0__.TextureLoader(
									this.options.manager
								);
						} else {
							this.textureLoader =
								new three__WEBPACK_IMPORTED_MODULE_0__.ImageBitmapLoader(
									this.options.manager
								);
						}
						...
						this.fileLoader = new three__WEBPACK_IMPORTED_MODULE_0__.FileLoader(
							this.options.manager
						);
					...
					loadAccessor(accessorIndex) {
						...
						if (
							...
							return Promise.resolve(
								new three__WEBPACK_IMPORTED_MODULE_0__.BufferAttribute(
									array,
									itemSize,
									normalized
								)
						...
						return Promise.all(pendingBufferViews).then(function (bufferViews) {
							...
							if (byteStride && byteStride !== itemBytes) {
								...
								bufferAttribute =
									new three__WEBPACK_IMPORTED_MODULE_0__.InterleavedBufferAttribute(
										ib,
										itemSize,
					...
					loadTextureImage(textureIndex, sourceIndex, loader) {
						...
						const cacheKey =
							(sourceDef.uri || sourceDef.bufferView) +
							":" +
							textureDef.sampler;
						...
						const promise = this.loadImageSource(sourceIndex, loader)
							.then(function (texture) {
								...
								texture.magFilter =
									WEBGL_FILTERS[sampler.magFilter] ||
									three__WEBPACK_IMPORTED_MODULE_0__.LinearFilter;
								texture.minFilter =
									WEBGL_FILTERS[sampler.minFilter] ||
									three__WEBPACK_IMPORTED_MODULE_0__.LinearMipmapLinearFilter;
								texture.wrapS =
									WEBGL_WRAPPINGS[sampler.wrapS] ||
									three__WEBPACK_IMPORTED_MODULE_0__.RepeatWrapping;
								texture.wrapT =
									WEBGL_WRAPPINGS[sampler.wrapT] ||
									three__WEBPACK_IMPORTED_MODULE_0__.RepeatWrapping;
								...
								return new Promise(function (resolve, reject) {
									...
									if (loader.isImageBitmapLoader === true) {
										onLoad = function (imageBitmap) {
											const texture =
												new three__WEBPACK_IMPORTED_MODULE_0__.Texture(
													imageBitmap
												);
											texture.needsUpdate = true;
					...
					assignFinalMaterial(mesh) {
						...
						if (mesh.isPoints) {
							...
							if (!pointsMaterial) {
								pointsMaterial =
									new three__WEBPACK_IMPORTED_MODULE_0__.PointsMaterial();
								three__WEBPACK_IMPORTED_MODULE_0__.Material.prototype.copy.call(
									pointsMaterial,
									material
								);
					...
					loadMaterial(materialIndex) {
						...
						if (materialExtensions[EXTENSIONS.KHR_MATERIALS_UNLIT]) {
							...
							materialParams.color =
								new three__WEBPACK_IMPORTED_MODULE_0__.Color(1.0, 1.0, 1.0);
							materialParams.opacity = 1.0;
						...
						if (
							...
							materialType !==
								three__WEBPACK_IMPORTED_MODULE_0__.MeshBasicMaterial
						) {
							pending.push(
								parser.assignTexture(
									materialParams,
							...
							materialParams.normalScale =
								new three__WEBPACK_IMPORTED_MODULE_0__.Vector2(1, 1);
					...
					createUniqueName(originalName) {
						const sanitizedName =
							three__WEBPACK_IMPORTED_MODULE_0__.PropertyBinding.sanitizeNodeName(
								originalName || ""
							);
								...
								if (
									...
									mesh =
										meshDef.isSkinnedMesh === true
											? new three__WEBPACK_IMPORTED_MODULE_0__.SkinnedMesh(
													geometry,
													material
												)
									...
									if (primitive.mode === WEBGL_CONSTANTS.TRIANGLE_STRIP) {
										mesh.geometry = (0,
										_utils_BufferGeometryUtils_js__WEBPACK_IMPORTED_MODULE_1__.toTrianglesDrawMode)(
											mesh.geometry,
											three__WEBPACK_IMPORTED_MODULE_0__.TriangleStripDrawMode
										);
									} else if (primitive.mode === WEBGL_CONSTANTS.TRIANGLE_FAN) {
										mesh.geometry = (0,
										_utils_BufferGeometryUtils_js__WEBPACK_IMPORTED_MODULE_1__.toTrianglesDrawMode)(
											mesh.geometry,
											three__WEBPACK_IMPORTED_MODULE_0__.TriangleFanDrawMode
										);
									}
								} else if (primitive.mode === WEBGL_CONSTANTS.LINES) {
									mesh = new three__WEBPACK_IMPORTED_MODULE_0__.LineSegments(
										geometry,
										material
									);
								} else if (primitive.mode === WEBGL_CONSTANTS.LINE_STRIP) {
									mesh = new three__WEBPACK_IMPORTED_MODULE_0__.Line(
										geometry,
										material
									);
								} else if (primitive.mode === WEBGL_CONSTANTS.LINE_LOOP) {
									mesh = new three__WEBPACK_IMPORTED_MODULE_0__.LineLoop(
										geometry,
										material
									);
								} else if (primitive.mode === WEBGL_CONSTANTS.POINTS) {
									mesh = new three__WEBPACK_IMPORTED_MODULE_0__.Points(
										geometry,
										material
									);
								} else {
					...
					loadCamera(cameraIndex) {
						...
						if (cameraDef.type === "perspective") {
							camera = new three__WEBPACK_IMPORTED_MODULE_0__.PerspectiveCamera(
								three__WEBPACK_IMPORTED_MODULE_0__.MathUtils.radToDeg(
									params.yfov
								),
					...
					loadSkin(skinIndex) {
						...
						return Promise.all(pending).then(function (results) {
							...
							return new three__WEBPACK_IMPORTED_MODULE_0__.Skeleton(
								bones,
								boneInverses
							);
						});
					...
					loadAnimation(animationIndex) {
						...
						for (let i = 0, il = animationDef.channels.length; i < il; i++) {
							...
							pendingOutputAccessors.push(
								this.getDependency("accessor", output)
							);
						...
						return Promise.all([
							...
							return new three__WEBPACK_IMPORTED_MODULE_0__.AnimationClip(
								animationName,
								undefined,
								tracks
							);
						...
						return Promise.all(pending).then(function (nodes) {
							...
							const reduceAssociations = node => {
								...
								for (const [key, value] of parser.associations) {
									if (
										key instanceof
											three__WEBPACK_IMPORTED_MODULE_0__.Material ||
										key instanceof three__WEBPACK_IMPORTED_MODULE_0__.Texture
									) {
					...
					_createAnimationTracks(
						...
						switch (PATH_PROPERTIES[target.path]) {
							case PATH_PROPERTIES.weights:
								TypedKeyframeTrack =
									three__WEBPACK_IMPORTED_MODULE_0__.NumberKeyframeTrack;
								break;

							case PATH_PROPERTIES.rotation:
								TypedKeyframeTrack =
									three__WEBPACK_IMPORTED_MODULE_0__.QuaternionKeyframeTrack;
								break;

							case PATH_PROPERTIES.position:
							case PATH_PROPERTIES.scale:
								TypedKeyframeTrack =
									three__WEBPACK_IMPORTED_MODULE_0__.VectorKeyframeTrack;
								break;
						...
						const interpolation =
							sampler.interpolation !== undefined
								...
								: three__WEBPACK_IMPORTED_MODULE_0__.InterpolateLinear;
				...
				function addPrimitiveAttributes(geometry, primitiveDef, parser) {
					...
					if (
						three__WEBPACK_IMPORTED_MODULE_0__.ColorManagement
							.workingColorSpace !==
							three__WEBPACK_IMPORTED_MODULE_0__.LinearSRGBColorSpace &&
						"COLOR_0" in attributes
					) {
						console.warn(
							`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${three__WEBPACK_IMPORTED_MODULE_0__.ColorManagement.workingColorSpace}" not supported.`
						);
					}
		...
		"../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/utils/BufferGeometryUtils.js":
			/*!***********************************************************************************************************!*\
  !*** ../../node_modules/.pnpm/three@0.169.0/node_modules/three/examples/jsm/utils/BufferGeometryUtils.js ***!
  \***********************************************************************************************************/
			function (
				...
				__webpack_require__.d(__webpack_exports__, {
					toTrianglesDrawMode: (/* @common:endif */) =>
						/* @common:if [condition="treeShake.three/examples/jsm/loaders/GLTFLoader.js.toTrianglesDrawMode"] */ toTrianglesDrawMode
				});
				/* ESM import */ var three__WEBPACK_IMPORTED_MODULE_0__ =
					/* #__PURE__ */ __webpack_require__(
						/*! three */ "webpack/sharing/consume/default/three/three"
				...
				function mergeGeometries(geometries, useGroups = false) {
					...
					for (const name in morphAttributes) {
						...
						for (let i = 0; i < numMorphTargets; ++i) {
							...
							const mergedMorphAttribute = mergeAttributes(
				...
				function mergeVertices(geometry, tolerance = 1e-4) {
					...
					for (const name in geometry.attributes) {
						...
						for (let j = 0; j < tmpMorphAttributes[name].length; j++) {
							...
							result.morphAttributes[name][j] =
								new tmpMorphAttribute.constructor(
				...
				function toTrianglesDrawMode(geometry, drawMode) {
					if (
						drawMode === three__WEBPACK_IMPORTED_MODULE_0__.TrianglesDrawMode
					) {
						console.warn(
				...
				function toCreasedNormals(
					...
					const resultGeometry = geometry.index
