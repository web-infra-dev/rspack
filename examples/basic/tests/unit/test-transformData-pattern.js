...
const correctPattern = '/* @common:if [condition="treeShake.cjs-module-exports.transformData"] */ transformData, /* @common:endif */';
...
const linesWithIncorrectPattern = content.split('\n').filter(line => 
    line.includes('transformData') && line.includes(incorrectPattern)
);
