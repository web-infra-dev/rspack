...
use crate::{
  ...
  runtime_module::{
    ...
    DefinePropertyGettersRuntimeModule, DefinePropertyRuntimeModule,
    ...
    TypeScriptImportDefaultRuntimeModule, TypeScriptReadRuntimeModule, TypeScriptRestRuntimeModule,
    chunk_has_css, is_enabled_for_chunk,
  },
};
...
async fn runtime_requirements_in_tree(
  ...
  for runtime_requirement in runtime_requirements.iter() {
    match runtime_requirement {
      ...
      RuntimeGlobals::DEFINE_PROPERTY => {
        runtime_modules_to_add.push((
          *chunk_ukey,
          DefinePropertyRuntimeModule::new(&compilation.runtime_template).boxed(),
        ));
      }
      ...
      RuntimeGlobals::TYPESCRIPT_ASSIGN => {
        runtime_modules_to_add.push((
          *chunk_ukey,
          TypeScriptAssignRuntimeModule::new(&compilation.runtime_template).boxed(),
        ));
      }
      RuntimeGlobals::TYPESCRIPT_DECORATE => {
        runtime_modules_to_add.push((
          *chunk_ukey,
          TypeScriptDecorateRuntimeModule::new(&compilation.runtime_template).boxed(),
        ));
      }
      ...
      RuntimeGlobals::TYPESCRIPT_READ => {
        runtime_modules_to_add.push((
          *chunk_ukey,
          TypeScriptReadRuntimeModule::new(&compilation.runtime_template).boxed(),
        ));
      }
      RuntimeGlobals::TYPESCRIPT_REST => {
        runtime_modules_to_add.push((
          *chunk_ukey,
          TypeScriptRestRuntimeModule::new(&compilation.runtime_template).boxed(),
        ));
      }
