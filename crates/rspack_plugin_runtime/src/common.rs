use rspack_core::RUNTIME_PLACEHOLDER_INSTALLED_MODULES;

use crate::ChunkHash;

pub fn generate_common_init_runtime(namespace: &str) -> String {
  include_str!("runtime/common/_init_runtime.js")
    .to_string()
    .replace("__rspack_runtime__", namespace)
}

pub fn generate_common_module_and_chunk_data() -> String {
...
pub fn generate_common_check_by_id() -> String {
  include_str!("runtime/common/_check_by_id.js").to_string()
}

pub fn generate_common_public_path(public_path: &str) -> String {
  include_str!("runtime/common/_public_path.js")
    .to_string()
    .replace("__PUBLIC_PATH_PLACEHOLDER__", public_path)
}

pub fn generate_common_dynamic_data(js: Vec<ChunkHash>, css: Vec<ChunkHash>) -> String {
