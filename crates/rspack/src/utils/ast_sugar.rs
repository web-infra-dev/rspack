...
use swc_ecma_ast::{
    BindingIdent, CallExpr, Callee, Decl, ExportNamedSpecifier, ExportSpecifier, Expr,
    ExprOrSpread, Ident, KeyValueProp, Lit, MemberExpr, MemberProp, ModuleDecl, ModuleExportName,
    NamedExport, Null, ObjectLit, Pat, Prop, PropName, PropOrSpread, Stmt, Str, VarDecl,
