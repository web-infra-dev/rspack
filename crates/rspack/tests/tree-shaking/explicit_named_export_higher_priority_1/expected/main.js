...
(function() {
    ...
    (function() {
        runtime.__rspack_require__.hu = function(chunkId1) {
            return "" + chunkId1 + ".hot-update.js";
        };
    })();
    (function() {
    ...
    (()=>{
        var inProgress = {};
        runtime.__rspack_require__.l = (url, done, key, chunkId1)=>{
    ...
    (function() {
        ...
        function loadUpdateChunk(chunkId1, updatedModulesList) {
            currentUpdatedModulesList = updatedModulesList;
            return new Promise((resolve, reject)=>{
                var url = runtime.__rspack_require__.p + runtime.__rspack_require__.hu(chunkId1);
        ...
        self["hotUpdate"] = (chunkId1, moreModules, runtime)=>{
            for(var moduleId1 in moreModules)if (self["__rspack_runtime__"].__rspack_require__.o(moreModules, moduleId1)) {
        ...
        runtime.__rspack_require__.hmrC.jsonp = function(chunkIds, removedChunks, removedModules, promises, applyHandlers, updatedModulesList) {
            applyHandlers.push(applyHandler);
            currentUpdateChunks = {};
            ...
            chunkIds.forEach(function(chunkId1) {
                if (runtime.__rspack_require__.o(installedChunks, chunkId1) && void 0 !== installedChunks[chunkId1]) {
                    promises.push(loadUpdateChunk(chunkId1, updatedModulesList));
