...
const request = 'a';
__webpack_require__.el(/* ./child/a.js */"./child/a.js").then(__webpack_require__.bind(__webpack_require__, /* ./child/a.js */"./child/a.js")).then(__webpack_require__.ir).then(({ a  })=>console.log("Literal", a));
__webpack_require__.el(/* ./child/b.js */"./child/b.js").then(__webpack_require__.bind(__webpack_require__, /* ./child/b.js */"./child/b.js")).then(__webpack_require__.ir).then(({ b  })=>console.log("Template Literal", b));
