...
use crate::{
  RsdoctorAssetPatch, RsdoctorChunkGraph, RsdoctorLoaderProfilesPatch, RsdoctorModuleGraph,
...
define_hook!(RsdoctorPluginLoaderProfiles: SeriesBail(data: &mut RsdoctorLoaderProfilesPatch) -> bool);
...
pub struct RsdoctorPluginHooks {
  ...
  #[cfg_attr(allocative, allocative(skip))]
  pub loader_profiles: RsdoctorPluginLoaderProfilesHook,
}
