...
export function Item2({ id1, id2 }) {
    id1++;
    const temp = [];
    temp.push(/*#__PURE__*/ React.createElement(Button, {
        action: deleteItem
    }, "Delete"));
    id1++;
    temp.push(/*#__PURE__*/ React.createElement(Button, {
    ...
    return temp;
    var deleteItem = $$RSC_SERVER_ACTION_1.bind(null, encryptActionBoundArgs("40be8d67bb01f9fc1199f26e7d4bbc812d5446fe5337d20608749bb1de5f3e8caa", id1, id2));
}
