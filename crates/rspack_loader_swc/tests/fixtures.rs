...
async fn loader_test(actual: impl AsRef<Path>, expected: impl AsRef<Path>) {
  ...
  let compiler_options = CompilerOptions {
    ...
    output: rspack_core::OutputOptions {
      ...
      webassembly_module_filename: "".parse().always_ok(),
      chunk_filename: "".parse().always_ok(),
      ...
      css_chunk_filename: "".parse().always_ok(),
      css_filename: "".parse().always_ok(),
      hot_update_chunk_filename: "".parse().always_ok(),
      hot_update_main_filename: "".parse().always_ok(),
      ...
      module: false,
      trusted_types: None,
      source_map_filename: "./a.map.js".parse().always_ok(),
