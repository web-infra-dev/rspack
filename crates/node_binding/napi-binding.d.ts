...
export declare enum RegisterJsTapKind {
  ...
  CompilationAddEntry = 12,
  CompilationFailedEntry = 13,
  CompilationSucceedEntry = 14,
  CompilationFinishModules = 15,
  CompilationOptimizeModules = 16,
  CompilationAfterOptimizeModules = 17,
  CompilationOptimizeTree = 18,
  CompilationOptimizeChunkModules = 19,
...
export interface RegisterJsTaps {
  ...
  registerCompilationAddEntryTaps: (stages: Array<number>) => Array<{ function: ((entry: any, options: any) => void); stage: number; }>
  registerCompilationSucceedEntryTaps: (stages: Array<number>) => Array<{ function: ((entry: any, options: any, module: Module) => void); stage: number; }>
  registerCompilationFailedEntryTaps: (stages: Array<number>) => Array<{ function: ((entry: any, options: any, error: string) => void); stage: number; }>
