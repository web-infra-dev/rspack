...
export class ExternalObject<T> {
	readonly "": { readonly "": unique symbol; [K: symbol]: T };
}
export interface OnLoadContext { id: string }
export interface OnLoadResult { content?: string; loader?: string }
export interface OnResolveContext { importer?: string; importee: string }
export interface OnResolveResult { uri: string; external: boolean }
...
export interface ResolveRet { status: boolean; result?: string }
