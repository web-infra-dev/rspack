...
export interface RegisterJsTaps {
  ...
  registerNormalModuleFactoryFactorizeTaps: (stages: Array<number>) => Array<{ function: ((arg: JsFactorizeArgs) => Promise<[boolean | undefined, JsFactorizeOutput]>); stage: number; }>
