...
// When enabled, instruct cargo to emit JSON build messages so we can measure how
// many compile units were reused from the restored cache (Rust cache utilization).
...
function reportFreshStats({ fresh, total }) {
	...
	const summary = `${target}: ${fresh}/${total} units fresh = ${pct}% cache utilization`;
