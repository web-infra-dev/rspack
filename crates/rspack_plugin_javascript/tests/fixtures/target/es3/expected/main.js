self["__rspack_runtime__"].__rspack_register__([
    ...
    var __generator1 = (void 0) && (void 0).__generator || function(thisArg, body) {
        var f, y, t, g, _ = {
            label: 0,
            sent: function() {
                if (t[0] & 1) throw t[1];
    ...
    function _task() {
        _task = _asyncToGenerator1(function() {
            return __generator1(this, function(_state) {
                switch(_state.label){
                    case 0:
                        return [
                            4,
    ...
    function _main() {
        _main = _asyncToGenerator1(function() {
            return __generator1(this, function(_state) {
                switch(_state.label){
                    case 0:
                        return [
