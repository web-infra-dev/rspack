...
use rspack_core::{
  ...
  ModuleGraph, RealDependencyRange, RuntimeGlobals, RuntimeSpec, UsedName, DEFAULT_EXPORT,
};
...
impl DeclarationInfo {
  pub fn new(range: RealDependencyRange, prefix: String, suffix: String) -> Self {
    Self {
      range,
      prefix,
      suffix,
...
pub struct HarmonyExportExpressionDependency {
  id: DependencyId,
  range: RealDependencyRange,
  range_stmt: RealDependencyRange,
