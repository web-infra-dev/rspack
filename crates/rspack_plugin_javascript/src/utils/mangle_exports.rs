const START_LOWERCASE_ALPHABET_CODE: u32 = b'a' as u32;
const DELTA_A_TO_Z: u32 = b'z' as u32 - START_LOWERCASE_ALPHABET_CODE + 1u32;
const NUMBER_OF_IDENTIFIER_START_CHARS: u32 = DELTA_A_TO_Z * 2u32 + 2u32; // a-z A-Z _ $
const NUMBER_OF_IDENTIFIER_CONTINUATION_CHARS: u32 = NUMBER_OF_IDENTIFIER_START_CHARS + 10u32; // a-z A-Z _ $ 0-9
