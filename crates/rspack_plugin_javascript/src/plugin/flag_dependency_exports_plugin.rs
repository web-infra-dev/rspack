...
use rspack_core::{
  debug_all_exports_info, BuildMetaExportsType, Compilation, DependenciesBlock, Dependency,
  DependencyId, ExportInfoProvided, ExportNameOrSpec, ExportsInfoId, ExportsOfExportsSpec,
  ExportsSpec, ModuleGraph, ModuleGraphConnection, ModuleIdentifier, Plugin,
};
...
impl Plugin for FlagDependencyExportsPlugin {
  ...
  async fn finish_modules(&self, compilation: &mut Compilation) -> Result<()> {
    println!("FlagDependencyExportsProxy");
