...
use crate::{
  ...
  dependency::{
    ...
    CommonJsObjectExportDependencyTemplate, CommonJsRequireContextDependencyTemplate,
...
async fn compilation(
  ...
  compilation.set_dependency_template(
    CommonJsObjectExportDependencyTemplate::template_type(),
    Arc::new(CommonJsObjectExportDependencyTemplate::default()),
  );
  compilation.set_dependency_template(
