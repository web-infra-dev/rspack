...
pub(crate) use self::{
  ...
  common_js_imports_parse_plugin::{
    CREATE_REQUIRE_SPECIFIER_TAG, CREATED_REQUIRE_IDENTIFIER_TAG, CommonJsImportsParserPlugin,
    CreateRequireSpecifierTagData, CreatedRequireTagData, RequireReferencesState,
  },
