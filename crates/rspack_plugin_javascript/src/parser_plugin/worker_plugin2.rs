...
use crate::{
  dependency::WorkerDependency, utils::get_literal_str_by_obj_prop, visitors::JavascriptParser,
  webpack_comment::try_extract_webpack_magic_comment,
};

const DEFAULT_SYNTAX: [&str; 2] = [
  "Worker",
  "SharedWorker",
...
impl JavascriptParserPlugin for WorkerPlugin2 {
  fn new_expression(
    &self,
    parser: &mut JavascriptParser,
