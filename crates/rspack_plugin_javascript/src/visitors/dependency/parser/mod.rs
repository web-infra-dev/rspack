...
pub struct JavascriptParser<'parser> {
  ...
  pub(crate) in_unary_delete: bool,
  pub(crate) in_mutating_assignment_target_pattern: bool,
  pub(crate) mutating_assignment_target: Option<Span>,
...
impl<'parser> JavascriptParser<'parser> {
  ...
  pub fn new(
    ...
    Self {
      ...
      in_unary_delete: false,
      in_mutating_assignment_target_pattern: false,
      mutating_assignment_target: None,
