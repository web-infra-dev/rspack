...
use crate::{
  ...
  parser_plugin::{
    ...
    CommonJsBuiltinJavascriptParserPlugin, CommonJsExportsParserPlugin,
    EsmBuiltinJavascriptParserPlugin, ImportMetaDisabledPlugin, ImportMetaPlugin,
    ImportsReferencesState, InlineConstPlugin, InnerGraphParserPlugin, JavaScriptParserPluginDrive,
    JavascriptModuleBuiltinJavascriptParserPlugin, JavascriptParserPlugin, NodeStuffPlugin,
    RequireReferencesState, SideEffectsParserPlugin, inner_graph::state::InnerGraphState,
  },
...
impl<'parser> JavascriptParser<'parser> {
  ...
  pub fn new(
    ...
    plugins.push(Box::new(BaseBuiltinJavascriptParserPlugin::new()));
