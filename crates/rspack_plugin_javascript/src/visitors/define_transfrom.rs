use super::{DefineScanner, PatMetaInfo};
use std::collections::{HashMap, HashSet};
use swc_common::{sync::Lrc, FileName, SourceFile, Span};
...
impl DefineTransform {
  pub(crate) fn new(defintions: &HashMap<String, String>, prefix: DefineScanner) -> Self {
