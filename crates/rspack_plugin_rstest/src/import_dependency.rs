...
use rspack_core::{
  block_promise, get_exports_type, missing_module_promise, module_id, module_id_expr,
  module_namespace_promise, module_raw, weak_error, AsyncDependenciesBlockIdentifier, ChunkGraph,
  Compilation, Dependency, DependencyCodeGeneration, DependencyId, DependencyTemplate,
  DependencyTemplateType, DependencyType, ExportsType, FakeNamespaceObjectMode, ModuleDependency,
  ModuleGraph, RuntimeGlobals, TemplateContext, TemplateReplaceSource,
};
...
fn module_namespace_promise2(
  ...
  if compilation
    ...
    .is_none()
  {
    // return missing_module_promise2(request);
  ...
  let module_id_expr = module_id2(compilation, dep_id, request, weak);
