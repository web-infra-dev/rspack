...
use rspack_core::{
  ...
  CompilerId, ConcatenatedInnerModule, ConnectionState, DependenciesBlock, DependencyId,
  GroupOptions, Module, ModuleGraph, ModuleGraphCacheArtifact, ModuleGraphRef, ModuleId,
  ModuleIdentifier, ModuleType, NormalModule, RSCModuleType, RuntimeSpec, get_entry_runtime,
};
