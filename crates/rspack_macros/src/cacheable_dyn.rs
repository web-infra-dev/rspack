  ...
  quote! {
      #input
        ...
        const _: () = {
            ...
            impl #ty_generics SerializeUnsized<CacheableSerializer<'_>> for dyn #trait_ident #ty_generics #where_clause {
            ...
            impl #ty_generics DeserializeUnsized<dyn #trait_ident #ty_generics, CacheableDeserializer> for dyn #deserialize_trait_ident #ty_generics #where_clause {
            ...
            // CheckBytes
            unsafe impl #ty_generics CheckBytes<CacheableValidator<'_>> for dyn #deserialize_trait_ident #ty_generics #where_clause {
                #[inline]
