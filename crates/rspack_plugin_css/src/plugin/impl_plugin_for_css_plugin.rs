...
async fn runtime_requirements_in_tree(
  ...
  if all_runtime_requirements.contains(RuntimeGlobals::CSS_INJECT_STYLE) {
    runtime_requirements_mut.extend(CssLoadingRuntimeModule::get_runtime_requirements_with_style());
  }
  if all_runtime_requirements.contains(RuntimeGlobals::CSS_STYLE_SHEET) {
    runtime_requirements_mut
      .extend(CssLoadingRuntimeModule::get_runtime_requirements_with_style_sheet());
  }
