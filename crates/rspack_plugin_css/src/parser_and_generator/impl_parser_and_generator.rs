...
use rspack_core::{
  ...
  ChunkGraph, Compilation, ConstDependency, CssParserImport, CssParserImportContext, Dependency,
  DependencyRange, DependencyType, GenerateContext, Module, ModuleGraph, ModuleInitFragments,
  ModuleType, NormalModule, ParseContext, ParseResult, ParserAndGenerator, RuntimeGlobals,
