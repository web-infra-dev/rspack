...
use rspack_core::{
  ...
  ChunkUkey, CodeGenerationDataChunkInitFragments, CodeGenerationPublicPathAutoReplace,
  ...
  FindTargetResult, ImportSpec, InitFragmentKey, ModuleCodeGenerationContext, ModuleGraph,
