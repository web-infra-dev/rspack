...
use swc_core::{
  ...
  ecma::{
    ast::{
      CallExpr, Callee, Decl, Expr, Id, Ident, IdentName, Lit, MemberExpr, MemberProp, Module,
                  ...
                  let var = VarDeclarator {
                    ...
                    init: Some(Box::new(Expr::Member(MemberExpr {
                      ...
                      obj: Box::new(Expr::Call(CallExpr {
                        span: DUMMY_SP,
                        callee: Ident::new("require".into(), DUMMY_SP, self.unresolved_ctxt)
                          .as_callee(),
                        args: vec![Expr::Lit(Lit::Str(renamed.clone().into())).as_arg()],
                        ..Default::default()
                      })),
