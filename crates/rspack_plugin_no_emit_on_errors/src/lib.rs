...
use rspack_core::{
  ApplyContext, Compilation, CompilerOptions, CompilerShouldEmit, Plugin, PluginContext, Root,
};
...
async fn should_emit(&self, compilation: &mut Root<Compilation>) -> Result<Option<bool>> {
