...
use rspack_core::{
  bindings, ApplyContext, Compilation, CompilerOptions, CompilerShouldEmit, Plugin, PluginContext,
};
...
async fn should_emit(&self, compilation: &mut bindings::Root<Compilation>) -> Result<Option<bool>> {
