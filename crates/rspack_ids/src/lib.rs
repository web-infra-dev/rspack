mod compact_hashed_chunk_ids_plugin;
mod compact_hashed_id;
pub use compact_hashed_chunk_ids_plugin::*;
mod compact_hashed_module_ids_plugin;
pub use compact_hashed_module_ids_plugin::*;
