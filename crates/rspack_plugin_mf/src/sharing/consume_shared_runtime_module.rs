...
use rspack_core::{
  impl_runtime_module, rspack_sources::SourceExt, Chunk, ChunkGraph, ChunkUkey, Compilation,
  ModuleIdentifier, RuntimeGlobals, RuntimeModule, RuntimeModuleStage, SourceType,
};
