...
impl CodeSplitter {
  ...
  pub fn hit_cache(
    ...
    runtime: &RuntimeSpec,
    new_available_modules: FixedBitSet,
  ...
  pub fn available_modules_affected(
    ...
    // 0100
    // diff: 0110
    let mut diff = cache.available_modules.clone();
    diff.symmetric_difference_with(&new_available_modules);
