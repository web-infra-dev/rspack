...
define_hook!(CompilationStillValidModule: Series(compiler_id: CompilerId, compilation_id: CompilationId, module: &crate::BuiltModule));
...
impl Compilation {
  ...
  pub fn module_by_identifier(&self, identifier: &ModuleIdentifier) -> Option<&crate::BuiltModule> {
  ...
  pub fn get_import_var(
    ...
    target_module: Option<&crate::BuiltModule>,
    user_request: &str,
    phase: ImportPhase,
    runtime: Option<&RuntimeSpec>,
  ) -> String {
  ...
  pub async fn rebuild_module<T>(
    ...
    f: impl Fn(Vec<&crate::BuiltModule>) -> T,
  ) -> Result<T> {
