...
use crate::{BuildDependency, Compilation, DependencyIdSet, FactorizeInfo};
...
impl Cutout {
  ...
  pub fn cutout_artifact(
    ...
    let mut next_entry_dependencies = DependencyIdSet::default();
    ...
    let mut force_build_deps = DependencyIdSet::default();
