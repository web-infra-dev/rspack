...
use crate::{
  ...
  ChunkGraph, ChunkKind, Compilation, Compiler, ModuleExecutor, RuntimeSpec, RuntimeSpecMap,
};
...
impl Compiler {
  ...
  pub async fn rebuild(
    ...
    // build without stats
    {
      ...
      self.compilation = self.allocator.allocate_compilation(new_compilation);
