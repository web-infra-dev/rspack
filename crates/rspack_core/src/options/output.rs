...
//   fn default() -> Self {
//     Self::new(format!("{}.{}", NAME_PLACEHOLDER, NAME_PLACEHOLDER))
//   }
// }
...
// impl BaseFilename for Filename {
//   fn filename(&self, filename: String, ext: String) -> String {
//     self
//       .template
//       .replace(NAME_PLACEHOLDER, &filename)
...
// impl Default for ChunkFilename {
//   fn default() -> Self {
//     Self::new(format!("{}.{}", ID_PLACEHOLDER, NAME_PLACEHOLDER))
//   }
// }
...
// impl BaseFilename for ChunkFilename {
//   fn filename(&self, filename: String, ext: String) -> String {
//     self
//       .template
//       .replace(ID_PLACEHOLDER, &filename)
//       .replace(EXT_PLACEHOLDER, &ext)
//   }
...
//   fn default() -> Self {
//     Self::new("assets/".to_owned() + NAME_PLACEHOLDER + EXT_PLACEHOLDER)
//   }
// }
...
// impl BaseFilename for OutputAssetModuleFilename {
//   // TODO add more
//   fn filename(&self, filename: String, ext: String) -> String {
//     self
//       .template
