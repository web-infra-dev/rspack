...
use crate::{
  ApplyContext, BoxModule, BoxedParser, BoxedParserAndGeneratorBuilder, Compilation,
  CompilerOptions, Content, FactorizeAndBuildArgs, ModuleType, NormalModuleFactoryContext,
  OptimizeChunksArgs, ParseModuleArgs, Plugin, PluginBuildEndHookOutput, PluginContext,
