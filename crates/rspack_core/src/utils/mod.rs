...
pub fn compare_chunk_group(
  ...
  let chunks_a = &compilation.build_chunk_graph_artifact.chunk_group_by_ukey.expect_get(ukey_a).chunks;
  let chunks_b = &compilation.build_chunk_graph_artifact.chunk_group_by_ukey.expect_get(ukey_b).chunks;
