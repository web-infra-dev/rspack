...
use rspack_core::{
  ...
  BoxModule, BuildChunkGraphArtifact, ChunkGraph, ChunkUkey, Compilation,
  ...
  ContextModuleFactoryBeforeResolveHook, ExecuteModuleId, ExportsInfoArtifact,
  ImportedByDeferModulesArtifact, Module, ModuleFactoryCreateData, ModuleId, ModuleIdentifier,
