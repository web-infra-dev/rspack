...
static GLOBAL: rspack_allocator::MiMalloc = rspack_allocator::MiMalloc;

#[global_allocator]
#[cfg(all(feature = "sftrace-setup", not(feature = "system-allocator")))]
static GLOBAL: sftrace_setup::SftraceAllocator<rspack_allocator::MiMalloc> =
  sftrace_setup::SftraceAllocator(rspack_allocator::MiMalloc);
