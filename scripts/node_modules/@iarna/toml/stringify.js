...
function stringify (obj) {
  ...
  return stringifyObject('', '', obj, false)
}
...
function stringifyObject (prefix, indent, obj, allInline = true) {
  obj = toJSON(obj)
  let inlineKeys
  let complexKeys
  inlineKeys = allInline ? Object.keys(obj) : getInlineKeys(obj)
  complexKeys = allInline ? [] : getComplexKeys(obj)
  const result = []
