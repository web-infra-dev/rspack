...
- The [Rolldown](https://github.com/rolldown-rs/rolldown) project created by [Rolldown team](https://github.com/sponsors/rolldown-rs), which explore the possibility of making a performant bundler in rust with Rollup-compatible API. It inspires the design principles of Rspack.
