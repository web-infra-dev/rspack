...
function renderRuntimeModules(runtimeModules, renderContext) {
...
export function createModulePlaceholderPlugin() {
	Template.renderRuntimeModules = renderRuntimeModules;
	return {
		apply(compiler) {
