...
type ModuleFederationManifestPluginOptions = {
    ...
    additionalData?: (options: AdditionalDataOptions) => Promise<Stats_2 | void> | Stats_2 | void;
};
...
// @public (undocumented)
type StatsMetaData = StatsMetaDataWithGetPublicPath | StatsMetaDataWithPublicPath;
