...
function getInlineRscRuntimePluginFactorySource(): string {
  return [
    ...
    "      assertNoConflict(hostManifest.moduleLoading, alias, remoteManifest.moduleLoading, alias, 'moduleLoading');",
    '      hostManifest.moduleLoading[alias] = Object.assign({}, remoteManifest.moduleLoading);',
    '    }',
    '    if (isObject(remoteManifest.entryCssFiles)) {',
    '      var nextEntryCssFiles = cloneEntryCssFiles(remoteManifest.entryCssFiles);',
    "      assertNoConflict(hostManifest.entryCssFiles, alias, nextEntryCssFiles, alias, 'entryCssFiles');",
    '      hostManifest.entryCssFiles[alias] = nextEntryCssFiles;',
    '    }',
    ...
    "      assertNoConflict(hostManifest.entryJsFiles, alias, nextEntryJsFiles, alias, 'entryJsFiles');",
    '      hostManifest.entryJsFiles[alias] = nextEntryJsFiles;',
    '    }',
