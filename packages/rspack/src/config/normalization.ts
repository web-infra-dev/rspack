...
// 	 * @example
// 	 * ```js
// 	 * import: ['./src/index.js', './src/foo.js']
// 	 * ```
// 	 */
// 	import?: string[];
// 	/**
// 	 * The name of the runtime chunk. When `runtime` is set, a new runtime chunk
// 	 * will be created. You can also set it to `false` to avoid a new runtime chunk.
// 	 */
// 	runtime?: EntryRuntime;
// 	/**
// 	 * How this entry load other chunks. Methods included by default are `'jsonp'` (web),
// 	 * `'import'` (ESM), `'import-scripts'` (WebWorker), `'require'` (sync node.js),
// 	 * `'async-node'` (async node.js), but others might be added by plugins.
// 	 */
