...
type Compilation = {
  ...
  fileDependencies: FileSystemDependencies; // dependent files
  contextDependencies: FileSystemDependencies; // dependent directories
  missingDependencies: FileSystemDependencies; // dependent missing files
  buildDependencies: FileSystemDependencies; // dependent build files
