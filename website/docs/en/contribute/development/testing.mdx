...
:::warning Notice
If you encounter any problems, please do not modify the original code of the webpack test cases. You can copy it and follow the [Rspack Testing](./testing-rspack) to create new test cases in `tests/rspack-test`.
:::
...
Rspack's test cases are stored in the `tests/rspack-test` folder, including unique test cases and cases that require modification for webpack and webpack plugins.
