---
description: 'Rspack contributor docs overview covering project architecture, development workflow, testing, debugging, and releases.'
---
...
7. Run `pnpm run lint:js` to check JS code, and run `pnpm run lint:rs` to check Rust code.
