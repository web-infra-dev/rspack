...
In Rspack 2.0, `builtin:swc-loader` no longer allows reading `.swcrc` files. You need to migrate your SWC configuration to the loader options in `rspack.config.js`:
