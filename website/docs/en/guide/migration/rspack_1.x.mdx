...
Rspack 2.0 adds an experimental `experiments.pureFunctions` switch for finer-grained, pure-function-based tree shaking across modules.
...
For more details, see the [tree shaking guide](/guide/optimization/tree-shaking#purefunctions).
