...
Rspack 2.0 adds an experimental [`experiments.pureFunctions`](/config/experiments#experimentspurefunctions) switch for finer-grained, pure-function-based tree shaking across modules. It is enabled by default.

You can choose one of these entry points depending on your code ownership:
