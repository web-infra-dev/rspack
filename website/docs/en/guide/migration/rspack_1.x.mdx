...
### `@module-federation/runtime-tools` becomes an optional dependency

The `@module-federation/runtime-tools` package has been moved from `dependencies` to `optionalDependencies`. If you are using [ModuleFederationPlugin](/plugins/webpack/module-federation-plugin), please ensure that this package is installed.
