...
For configuration details, see [`experiments.pureFunctions`](/config/experiments#experimentspurefunctions) and [`module.parser.javascript.pureFunctions`](/config/module-parser-javascript#moduleparserjavascriptpurefunctions).
