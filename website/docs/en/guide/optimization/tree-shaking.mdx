...
This feature is currently experimental and depends on [optimization.sideEffects](/config/optimization#optimizationsideeffects) (`sideEffects` is enabled by default in production mode). If you disable `optimization.sideEffects`, pure-function hints will not be analyzed.
...
For configuration details, see [`module.parser.javascript.pureFunctions`](/config/module-parser#javascriptpurefunctions).
