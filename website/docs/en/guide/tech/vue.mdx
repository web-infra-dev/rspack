---
description: 'Use Vue with Rspack, covering setup, configuration, integration details, and framework-specific development patterns.'
---
...
export default {
  module: {
    rules: [
      ...
      {
        test: /\.(?:js|mjs|ts)$/, // add this rule when you use TypeScript in Vue SFC
