---
description: 'Use React with Rspack, covering setup, configuration, integration details, and framework-specific development patterns.'
---
...
You can add [builtin:swc-loader](/guide/features/builtin-swc-loader) loader to support `.js`, `.mjs`, `.jsx`, `.ts`, and `.tsx` files:
...
If you need to use React Server Components, please refer to [Rspack - React Server Components](/guide/tech/rsc).
