...
It's possible to use the type of Rspack specific features in your TypeScript code, such as [import.meta.glob](/api/runtime-api/module-variables#importmetaglob) and [import.meta.webpackContext](/api/runtime-api/module-variables#importmetawebpackcontext).
