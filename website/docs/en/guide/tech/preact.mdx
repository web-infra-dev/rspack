---
description: 'Use Preact with Rspack, covering setup, configuration, integration details, and framework-specific development patterns.'
---
...
Refer to [examples/preact-refresh](https://github.com/rstackjs/rstack-examples/tree/main/rspack/preact-refresh) for the full example.
