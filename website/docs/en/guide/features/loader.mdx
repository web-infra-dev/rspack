---
description: 'Rspack has built-in support for JavaScript, CSS, JSON, and static assets modules'
---
...
You can chain multiple loaders for a particular [Rule](/config/module#modulerules) match, with the loaders executed in right-to-left order.
