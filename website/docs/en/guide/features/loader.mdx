...
A loader is a transformer that converts various types of modules into formats that Rspack can understand and bundle. By using different kinds of loaders, you can extend Rspack to process additional module types, such as JSX, Markdown, Sass, Less and more.
...
Although Rspack provides built-in support for CSS, for `.less` files, you need to use an external [less-loader](https://github.com/webpack-contrib/less-loader) to transform the contents of the `.less` file accordingly.
