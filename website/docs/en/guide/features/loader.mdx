...
Loader is a module transformer that converts various types of modules into formats that Rspack can understand and bundle. Through Loaders, you can extend Rspack to process additional module types (such as JSX, Markdown, Sass, Less, etc.).
