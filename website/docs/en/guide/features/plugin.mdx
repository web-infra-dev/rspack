...
You can also refer to [Community plugin compatibility](/plugins/community-plugin-compatibility) for the list of webpack plugins that have passed Rspack compatibility tests.
