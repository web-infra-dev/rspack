...
If you wish to modify this behavior, you can use [`module.parser.asset.dataUrlCondition`](/config/module-parser#asset) to modify the global configuration, or use [`rules[].parser.dataUrlCondition`](/config/module-parser#assetdataurlcondition) to configure it separately for a specific eligible module.
