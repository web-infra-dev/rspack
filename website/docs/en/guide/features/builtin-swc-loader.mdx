...
Whether to collect type exports information for [`typeReexportsPresence`](/config/module-parser#javascripttypereexportspresence). This is used to check type exports of submodules when running in `'tolerant'` mode.
