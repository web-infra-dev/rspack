...
Use [`module.parser.javascript.worker`](/config/module-parser-javascript#moduleparserjavascriptworker) to tell Rspack which expressions should be analyzed as worker-like entry creation:
