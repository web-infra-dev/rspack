...
Use [`module.parser.javascript.worker`](/config/module-parser#javascriptworker) to tell Rspack which expressions should be analyzed as worker-like entry creation:
...
<Attribution url="https://webpack.js.org/guides/web-workers/" />
