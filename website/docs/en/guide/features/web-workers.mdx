...
Use [`module.parser.javascript.worker`](/config/module-parser#parserjavascriptworker) to tell Rspack which expressions should be analyzed as worker-like entry creation:
