...
Starting from v3.6, Docusaurus supports using Rspack as the bundler, see more details in [Docusaurus Faster](https://docusaurus.io/blog/releases/3.6#docusaurus-faster).
