...
Rspack 1.4 includes a Wasm binding, which makes Rspack available in StackBlitz/WebContainer. Currently, if you want to preview your Rspack projects on StackBlitz, you need to specify the cpu architecture when installing dependencies. Different package managers have different ways to do it.
