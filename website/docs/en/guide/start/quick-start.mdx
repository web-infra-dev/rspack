...
[Rspeedy](https://lynxjs.org/rspeedy/) is an Rspack-based build tool specifically designed for Lynx applications. [Lynx](https://lynxjs.org/) is a family of technologies empowering developers to use their existing web skills to create truly native UIs for both mobile and web from a single codebase.
