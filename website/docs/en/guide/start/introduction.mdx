---
description: 'Rspack Introduction guide covering Why Rspack?, Current status of Rspack, and Comparisons with other tools.'
---
...
<div>
  ...
  <p style={{ display: 'inline', lineHeight: '1.75rem' }}>
    <span>) is a fast Rust-based bundler for the web.</span>
    <span>&nbsp;It modernizes the webpack API to</span>
    <span>&nbsp;enable seamless replacement of webpack while</span>
    <span>&nbsp;delivering lightning-fast build speeds.</span>
  </p>
</div>
...
Rspack is currently compatible with almost all loaders in the community. For the 50 most downloaded [webpack plugins](/plugins/community-plugin-compatibility), more than 85% can be used in Rspack or have an alternative.

:::tip Learn more

- See [Rspack blogs](/blog/) for the latest updates on Rspack.
