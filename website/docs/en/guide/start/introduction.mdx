...
In August 2024, we released [Rspack 1.0](/blog/announcing-1-0), which is is production-ready and covers most of webpack's APIs and features.

Rspack is currently compatible with almost all loaders in the community. For the 50 most downloaded webpack plugins, more than 80% can be used in Rspack or have an alternative.
