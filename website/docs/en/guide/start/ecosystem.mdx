---
description: 'Rstack is a unified JavaScript toolchain centered on Rspack, with high performance and consistent architecture'
---
...
[Angular Rspack](https://nx.dev/docs/technologies/angular/angular-rspack) is a set of plugins and tools to make it easy and straightforward to build Angular applications with Rspack and Rsbuild.
...
<Tag color="geekblue">Build tool</Tag>
<Tag color="purple">Rails</Tag>

[Shakapacker](https://shakapacker.com/) handles compiling rails frontend assets. See [Rspack setup Docs](https://github.com/shakacode/shakapacker/blob/main/docs/rspack.md)

### Shipwright

<Tag color="geekblue">Build tool</Tag>
<Tag color="purple">Sails.js</Tag>

[Shipwright](https://github.com/balderdashy/sails-hook-shipwright) is a Sails.js hook that uses Rsbuild as the frontend asset pipeline for Sails applications.

It replaces the legacy Grunt pipeline with fast builds, HMR in development, and framework plugins for React, Vue, and Svelte.
...
<Tag color="geekblue">Full-stack starter</Tag>
<Tag color="purple">Sails.js</Tag>

[The Boring JavaScript Stack](https://github.com/sailscastshq/boring-stack) is an opinionated full-stack JavaScript starter built with Sails.js, Inertia.js, and Rsbuild-powered frontend assets.

It uses Shipwright to provide fast builds, HMR in development, and React, Vue, or Svelte support through Rsbuild plugins.
