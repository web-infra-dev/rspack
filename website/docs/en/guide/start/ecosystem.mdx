...
It uses [Shipwright](https://github.com/sailshq/sails-hook-shipwright) to provide fast builds, HMR in development, and React, Vue, or Svelte support through Rsbuild plugins.
