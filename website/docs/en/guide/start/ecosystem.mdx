...
[Shakapacker](https://shakapacker.com/) handles compiling rails frontend assets. See [Shakapacker Rspack Docs](https://github.com/shakacode/shakapacker/blob/main/docs/rspack.md)
