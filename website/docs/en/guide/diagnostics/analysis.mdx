---
description: 'Analyze Rspack bundle output, duplicate dependencies, and module relationships with Rsdoctor and other analysis tools.'
---
...
[Rsdoctor](/guide/diagnostics/use-rsdoctor) provides the `Bundle Size` module, which is mainly used to analyze the information of the outputs of Rspack, including the size of resources, duplicate packages, and module reference relationships:
...
You can also generate a `stats.json` file for further analysis with other bundle analysis tools like [bundle-stats](https://github.com/relative-ci/bundle-stats) or [statoscope](https://github.com/statoscope/statoscope):
