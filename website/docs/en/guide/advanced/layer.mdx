---
description: 'Learn how module layers categorize dependency trees for layer-specific rules, compilation targets, and code splitting.'
---

# Module layers

Module layers let you categorize and manage modules in Rspack. By assigning different layers to modules, you can perform differentiated processing for different types of modules, such as:
