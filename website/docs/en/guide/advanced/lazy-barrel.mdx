---
description: 'Learn how Rspack optimizes barrel files by skipping the build of unused re-export modules.'
---

# Barrel file optimization

Rspack's barrel file optimization, also known as lazy barrel, improves build performance by skipping the building of unused re-export modules in side-effect-free barrel files.
