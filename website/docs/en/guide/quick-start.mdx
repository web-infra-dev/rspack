...
- [Migrating from Webpack to Rspack](/guide/migrate-from-webpack)
- [Migrating from Webpack to Rsbuild](https://rsbuild.dev/zh/guide/migration/webpack)
- [Migrating from Vue CLI to Rsbuild](https://rsbuild.dev/zh/guide/migration/vue-cli)
- [Migrating from Create React App to Rsbuild](https://rsbuild.dev/zh/guide/migration/cra)
