---
description: 'It''s possible to specify loaders in an import statement, or any equivalent "importing" method'
---
...
<Attribution url="https://webpack.js.org/concepts/loaders/#inline" />
