---
description: 'Inline matchResource allows you to dynamically change the matching rules when loading resources'
---
...
<Attribution url="https://webpack.js.org/api/loaders/#inline-matchresource" />
