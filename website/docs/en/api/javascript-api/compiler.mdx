---
description: "The Compiler is a core object in Rspack. A Compiler instance is created when you call Rspack's JavaScript API or CLI"
---
...
The Compiler is a core object in Rspack. A Compiler instance is created when you call Rspack's [JavaScript API](/api/javascript-api/) or [CLI](/api/cli).
...
A common example is accessing the [sources](/api/javascript-api/#sources-object) object in a Rspack plugin:
...
Get all the [full options](/config/) used by the compilers.
