...
- [napi-rs#2867](https://github.com/napi-rs/napi-rs/issues/2867): Currently, in projects using `@rspack/browser`, you need to inject `process.env.NODE_DEBUG_NATIVE`. If your are using Rspack to bundle your project, refer to [DefinePlugin](/plugins/webpack/define-plugin).
