...
To understand which APIs are backed by native state, how long returned objects remain valid, and
how cross-language calls affect performance, see
[JavaScript API architecture](/api/javascript-api/architecture).
