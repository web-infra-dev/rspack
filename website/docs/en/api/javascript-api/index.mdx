---
description: 'Rspack JavaScript API overview covering compiler creation, watch mode, stats access, and programmatic build workflows.'
---
...
Rspack's JavaScript API differs from webpack's in its lifecycle and performance characteristics.
See [JavaScript API architecture](/api/javascript-api/architecture).
...
<Attribution url="https://webpack.js.org/api/node/" />
