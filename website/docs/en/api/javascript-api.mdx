...
All available options and presets are described in the [stats configurations](/config/stats), and the generated data is described in the [stats object](/api/objects/stats).
