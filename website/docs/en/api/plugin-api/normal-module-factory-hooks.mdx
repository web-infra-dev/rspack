...
- This hook is only called for failures of ordinary path resolution. It is not called for module specifiers with a scheme (URI), loader resolution failures, or other kinds of errors.
