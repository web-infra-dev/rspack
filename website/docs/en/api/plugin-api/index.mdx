---
description: 'Rspack plugin API overview covering hook categories, compatibility status, and patterns for writing compatible plugins.'
---
...
- [ExternalModule hooks](/api/plugin-api/external-module-hooks): Control how external modules are assigned to chunks
...
- [NormalModule hooks](/api/plugin-api/normal-module-hooks): Intervene in how an individual module is built
