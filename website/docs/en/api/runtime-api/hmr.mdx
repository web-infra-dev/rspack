---
description: 'Rspack provides webpack HMR APIs and a separate import.meta.hot context'
---
...
- `import.meta.hot` is a separate per-module context. It supports only the four
  `accept` forms described below, `data`, and `dispose`.

Enable these APIs with the [HotModuleReplacementPlugin](/plugins/webpack/hot-module-replacement-plugin). In ESM, use `import.meta.webpackHot` for the webpack API or `import.meta.hot` for the separate context instead of `module.hot`.
