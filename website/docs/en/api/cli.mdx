---
description: '@rspack/cli is the command line tool for Rspack, providing a variety of commands to make working with Rspack easier'
---
...
| Flag                   | Description                                                                                                                                   |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `-c, --config [value]` | Specify the path to the configuration file, see [Specify the configuration file](/config/#specify-the-configuration-file)                     |
