---
description: 'The following Node.js options configure whether to polyfill or mock certain Node.js globals'
---
...
- `true`: Replace with the relative file path of the source file, relative to the [`context`](/config/context) option
...
<Attribution url="https://webpack.js.org/configuration/node/" />
