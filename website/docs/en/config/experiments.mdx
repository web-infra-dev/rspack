...
This option is deprecated. `topLevelAwait` will be removed in Rspack v2.0.0.

Setting `experiments.topLevelAwait` to false has no effect as this feature is always enabled since Rspack v1.15.0.
