...
The rspack cache configuration is different from the webpack cache configuration. You can refer to the following sample code to migrate the webpack cache configuration.
