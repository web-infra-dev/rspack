...
Enables a faster module concatenation implementation. It reuses identifier information collected while parsing modules, avoiding an additional parse of inner-module sources during concatenated-module code generation.
