...
In normal project, there are not much files need to be access by the input file system, config `experiments.useInputFileSystem` properly will keep Rspack running fast.
