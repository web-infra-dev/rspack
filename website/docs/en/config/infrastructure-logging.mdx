---
description: 'Options for infrastructure level logging. Generally used for logs unrelated to the Compilation'
---
...
<Attribution url="https://webpack.js.org/configuration/infrastructureLogging/" />
