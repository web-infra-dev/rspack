---
description: "Rspack's filename-related options support placeholders"
---
...
Entry chunks and chunks produced by [optimization.splitChunks](/plugins/split-chunks-plugin) are loaded via `<script>` tags in HTML. If filenames contain hashes, the HTML file cannot update dynamically, which breaks HMR.
