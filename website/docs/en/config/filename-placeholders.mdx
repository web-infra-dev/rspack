...
Different options support different types of placeholders. This page lists all context types available in Rspack, the placeholders each context provides, and which filename options use which context.
...
The following table summarizes common filename options and the context types they support:

| Option                                                                             | Context Types                  | Description                   |
| ---------------------------------------------------------------------------------- | ------------------------------ | ----------------------------- |
...
type PathData = {
  ...
  contentHash: string;
  contentHashWithLength: (n: number) => string;
  filename: string;
  url: string;
