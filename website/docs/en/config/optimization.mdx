...
This page documents config entries such as `splitChunks.enforceSizeThreshold`. For more background and the broader plugin-oriented reference, see the [SplitChunksPlugin](/plugins/webpack/split-chunks-plugin) page.
