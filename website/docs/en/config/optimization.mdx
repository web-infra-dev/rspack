...
The `compat-hashed` option uses the shortest available prefix of a stable alphanumeric hash as the chunk id, balancing long-term caching, bundle size, and runtime performance.
