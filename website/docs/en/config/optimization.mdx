...
:::danger
It is danger to disable this optimization, as doing so may not only significantly increase the bundle size but also greatly slow down the build process.
:::
