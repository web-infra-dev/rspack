...
For available options such as [`splitChunks.enforceSizeThreshold`](/plugins/webpack/split-chunks-plugin#splitchunksenforcesizethreshold), see the [SplitChunksPlugin](/plugins/webpack/split-chunks-plugin) page.
