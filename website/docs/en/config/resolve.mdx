...
- `false`: Do not use a global PnP manifest. Instead, resolve the PnP manifest in each project. This supports cross-referenced projects with `enableGlobalCache` disabled.
