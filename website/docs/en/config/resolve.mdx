...
- **Type:** `string`
- **Default:** the closest `.pnp.cjs` file

The path to the PnP manifest file. Rspack will attempt to find the closest `.pnp.cjs` file if `resolve.pnp` is enabled and this option is not provided.
