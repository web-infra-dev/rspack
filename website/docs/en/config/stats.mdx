...
Whether to show the [base directory](/config/context), an absolute path for shortening the request information.

### stats.publicPath

<PropertyType type="boolean" defaultValueList={[{ defaultValue: 'true' }]} />

Whether to show the [`publicPath`](/config/output#outputpublicpath).

### stats.outputPath

<PropertyType type="boolean" defaultValueList={[{ defaultValue: 'true' }]} />

Whether to show the [`output.path`](/config/output#outputpath).

### stats.children

<PropertyType type="boolean" defaultValueList={[{ defaultValue: 'true' }]} />

Whether to add information about the children stats generated by child compilers.
