...
This page describes the options that affect the behavior of `@rspack/dev-server` (short: dev-server), based on `webpack-dev-server@5`，which facilitates rapid application development.
