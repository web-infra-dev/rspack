...
:::tip
Check out the [guide](/guide/advanced/lazy-compilation) for a quick start.
:::
...
- **JavaScript API:** Lazy compilation is disabled by default. After enabling `lazyCompilation`, register the lazy compilation middleware with your development server. See [Integrating with custom server](/guide/advanced/lazy-compilation#integrating-with-custom-server).
...
See [Filtering modules](/guide/advanced/lazy-compilation#filtering-modules) for configuration examples.
...
<Attribution url="https://webpack.js.org/configuration/experiments/#experimentslazycompilation" />
