...
The default behaviour is to generate a CSS file for the stylesheets, and load this file as an external resource in the html `<head>` of the template.
You can override this behaviour, by embedding exported CSS into the bundled javascript file.
