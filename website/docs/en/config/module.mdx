...
By default **only exports** the identifier mappings, without embedding any stylesheets in the template.
If you need your stylesheets to get injected and loaded in the template you need to disable this option, by setting to `false`.
