...
### module.generator["css/auto"].exportType

- **Type:** `'link' | 'text' | 'css-style-sheet' | 'style'`
- **Default:** `undefined`

Configure how CSS content is exported as the default export of CSS Modules.
...
### module.generator["css/global"].exportType

Same as [`module.generator["css/auto"].exportType`](#modulegeneratorcssautoexporttype).
...
### module.generator["css/module"].exportType
