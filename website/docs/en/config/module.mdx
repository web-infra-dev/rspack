...
Currently, Rspack does not support `LoaderContext.fs`, `LoaderContext.importModule`, and most methods on `LoaderContext._compilation`, `LoaderContext._compiler`, `LoaderContext._module`.
:::
