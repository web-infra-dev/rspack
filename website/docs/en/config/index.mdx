...
If the version of Node.js you are using supports the `--experimental-transform-types` feature, you can use the built-in ts transform functionality of Node.js without needing to install `ts-node`.
