...
- [Asset generator options](#generatorasset)
- [CSS generator options](#generatorcssauto)
- [JSON generator options](#generatorjsonjsonparse)
...
If `"url"`, a URL pointing to the asset will be generated based on [publicPath](#generatorassetpublicpath).
...
Same as [`module.generator["asset"].binary`](#generatorassetbinary).
...
Same as [`module.generator["asset"].dataUrl`](#generatorassetdataurl).
...
Same as [`module.generator["asset"].dataUrl.encoding`](#generatorassetdataurlencoding).
...
Same as [`module.generator["asset"].dataUrl.mimetype`](#generatorassetdataurlmimetype).
...
Same as [`module.generator["asset"].importMode`](#generatorassetimportmode).
...
Same as [`module.generator["asset"].filename`](#generatorassetfilename).
...
Same as [`module.generator["asset"].outputPath`](#generatorassetoutputpath).
...
Same as [`module.generator["asset"].publicPath`](#generatorassetpublicpath).
...
Same as [`module.generator["css/auto"].exportsOnly`](#generatorcssautoexportsonly).
...
Same as [`module.generator["css/auto"].esModule`](#generatorcssautoesmodule).
...
Same as [`module.generator["css/auto"].exportsConvention`](#generatorcssautoexportsconvention).
...
Same as [`module.generator["css/auto"].localIdentName`](#generatorcssautolocalidentname).
...
Same as [`module.generator["css/auto"].localIdentHashDigest`](#generatorcssautolocalidenthashdigest).
...
Same as [`module.generator["css/auto"].localIdentHashDigestLength`](#generatorcssautolocalidenthashdigestlength).
...
Same as [`module.generator["css/auto"].localIdentHashFunction`](#generatorcssautolocalidenthashfunction).
...
Same as [`module.generator["css/auto"].localIdentHashSalt`](#generatorcssautolocalidenthashsalt).
