...
| `'browserslist'`             | Infer the ECMAScript version based on the configured browserslist (default if browserslist config is available)                                                                                                                               |
...
For this case, you can define multiple Rspack configurations for bundling based on [MultiCompiler](/api/javascript-api#multicompiler).
