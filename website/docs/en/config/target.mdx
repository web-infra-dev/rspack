...
For browser applications, define the supported browsers in a shared [Browserslist](https://github.com/browserslist/browserslist) configuration (see [Browserslist](#browserslist) for details):
