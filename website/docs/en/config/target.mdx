...
The `esX` in the `target` configuration can only specify the ECMAScript version syntax of the code in the Rspack runtime. If you want to specify the ECMAScript version of the user code, you should use [builtin:swc-loader](/guide/builtin-swc-loader.html), or [babel-loader](https://www.npmjs.com/package/babel-loader), or [swc-loader](https://www.npmjs.com/package/swc-loader) to degrade the user code.
