...
With [`HtmlRspackPlugin`](/plugins/html-rspack-plugin), the grammar of the template is a bit different with `.ejs`(see [here](/plugins/html-rspack-plugin#template-syntax)), you can inject them like this:
