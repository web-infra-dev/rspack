---
description: 'Enabling HMR is straightforward and in most cases no options are necessary'
---
...
See [React - Fast Refresh](/guide/integrations/react#fast-refresh) for more details.
...
See [Preact - Fast Refresh](/guide/integrations/preact#preact-refresh) for more details.
