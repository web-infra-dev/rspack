---
description: 'Detects circular import dependencies between modules that will exist at runtime'
---
...
:::warning Deprecated
`CircularDependencyRspackPlugin` is deprecated. Use [`CircularCheckRspackPlugin`](/plugins/rspack/circular-check-rspack-plugin), which has better performance and a more reasonable API design.
:::
