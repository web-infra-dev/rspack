...
#### [\<%=: Escaped output](https://github.com/mde/ejs/blob/main/docs/syntax.md#-escaped-output)
...
#### [\<%-: Unescaped output](https://github.com/mde/ejs/blob/main/docs/syntax.md#--unescaped-output)
...
```json title="locals"
{
  "myHtml": "<strong>Rspacky</strong>"
, "myMaliciousHtml": "</p><script>document.write()</script><p>"
}
```
```html title="html"
<p>Hello, <strong>Rspacky</strong>.</p>
<p>Hello, &lt;strong&gt;Rspacky&lt;/strong&gt;.</p>
