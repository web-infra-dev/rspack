---
description: "Since v2.0, this plugin has already bean the implementation for library with type \"modern-module\", you should use config instead of using plugin directly"
---
