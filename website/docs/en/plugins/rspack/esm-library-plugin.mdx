---
description: 'Since v2.0, this plugin has already been the implementation for library with type "modern-module", you should use config instead of using plugin directly'
---
...
:::tip
Since v2.0, this plugin has already been the implementation for library with type ["modern-module"](/config/output#type-modern-module), you should use config instead of using plugin directly.
