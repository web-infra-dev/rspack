---
description: 'CompatHashedChunkIdsPlugin assigns compact ids using the shortest available prefixes of stable alphanumeric hashes to shrink bundles and speed runtime indexing'
---
