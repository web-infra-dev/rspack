---
description: 'Overview of Rspack plugin docs, including built-in plugins, webpack-compatible plugins, and reference entry points.'
---
...
- [CircularCheckRspackPlugin](/plugins/rspack/circular-check-rspack-plugin): Flags circular imports
- [CompatHashedChunkIdsPlugin](/plugins/rspack/compat-hashed-chunk-ids-plugin): Assigns compact, stable chunk ids using alphanumeric hash prefixes
- [CompatHashedModuleIdsPlugin](/plugins/rspack/compat-hashed-module-ids-plugin): Assigns compact, stable module ids using alphanumeric hash prefixes
...
- [CircularDependencyRspackPlugin](/plugins/rspack/circular-dependency-rspack-plugin): Deprecated. Use [CircularCheckRspackPlugin](/plugins/rspack/circular-check-rspack-plugin) instead.
...
See [Built-in plugins (webpack-aligned) - Overview](/plugins/webpack/) for more details.
