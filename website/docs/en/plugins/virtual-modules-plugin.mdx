---
description: 'VirtualModulesPlugin allows you to create, modify, and delete files in memory, and Rspack treats these virtual files as if they were real files existing in...'
---
...
The optional constructor argument maps each virtual file path to its contents. Paths are resolved relative to [compiler.context](/api/javascript-api/compiler#context).
