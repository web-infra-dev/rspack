...
The following dynamic entry selects `'fetch'` and enables it explicitly because the entry-specific type cannot be discovered during configuration normalization:
