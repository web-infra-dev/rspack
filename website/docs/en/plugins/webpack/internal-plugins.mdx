---
description: 'list of plugins used internally by Rspack, aligned with the plugins used internally by webpack'
---
...
[`externalsPresets.electron`](/config/externals#externalspresetselectron), [`externalsPresets.electronMain`](/config/externals#externalspresetselectronmain), [`externalsPresets.electronRenderer`](/config/externals#externalspresetselectronrenderer), and [`externalsPresets.electronPreload`](/config/externals#externalspresetselectronpreload) all rely on this plugin.
...
Chunks are loaded by `jsonp` in web environments.

### WebWorkerTemplatePlugin

`webworker.WebWorkerTemplatePlugin(options)`

Chunks are loaded by `importScripts` in web worker environments.
