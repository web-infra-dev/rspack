...
:::tip
The `WarnCaseSensitiveModulesPlugin` primarily checks for differences in the case of module identifiers. This check is based on the module identifier, not the file system.
:::
