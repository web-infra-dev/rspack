---
description: 'This plugin allows you to specify external dependencies that should not be bundled into the output files'
---
...
The [`externalsType`](/config/externals#externalstype) and [`externals`](/config/externals#externals) configurations leverage the plugin internally. Therefore, you can utilize the respective functionality directly through these configuration options without needing to use the plugin separately.
...
For more details, refer to [externals](/config/externals#externals).
