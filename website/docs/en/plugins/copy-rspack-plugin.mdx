---
description: 'Copies individual files or entire directories, which already exist, to the build directory'
---
...
<Attribution url="https://webpack.js.org/plugins/copy-webpack-plugin/#root" />
