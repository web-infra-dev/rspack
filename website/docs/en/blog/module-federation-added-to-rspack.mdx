---
description: 'The latest Rspack 0.5.0 introduces the highly anticipated Module Federation along with the new "v1.5" federation APIs'
...
new rspack.container.ModuleFederationPlugin({
  ...
  runtimePlugins: [
    fileURLToPath(new URL('./my-custom-plugin.js', import.meta.url)),
  ],
  remotes: {
