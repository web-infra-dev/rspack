---
description: 'Today, we’re excited to introduce next-rspack, a community-driven plugin bringing direct Rspack support to Next.js. This integration offers a fast, webpack-compatible alternative for teams not yet ready to adopt Turbopack.'
...
> Get started today by visiting our [documentation](/guide/integrations/next) or checking out the official [Next.js example](https://github.com/vercel/next.js/tree/canary/examples/with-rspack).
