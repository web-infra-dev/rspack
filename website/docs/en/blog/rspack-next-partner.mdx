...
Turbopack remains Vercel’s long-term strategy. Rspack is not replacing it. However, next-rspack provides an alternative solution for users who are deep coupled with webpack ecosystem and not ready to migrate to Turbopack.
