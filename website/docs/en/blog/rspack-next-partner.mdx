...
In the JavaScript ecosystem, Next.js has one of the most advanced build systems with sophisticated webpack configurations and plugins, making it an excellent touchstone for validating Rspack's compatibility and capabilities. Integrating Rspack into Next.js demonstrates Rspack's applicability in complex projects and provides Next.js users with an alternative solution to improve developer experience.
...
Get started today by visiting our [Rspack documentation](https://rspack.dev/guide/tech/next) or checking out the official [Next.js example](https://github.com/vercel/next.js/tree/canary/examples/with-rspack).
