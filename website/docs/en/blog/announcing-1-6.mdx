...
Starting from Rspack 1.6, the layer feature has become stable enough that the experimental flag [experiments.layers](/guide/features/layer) has been deprecated. You can now use the layer feature directly without the experimental flag.
