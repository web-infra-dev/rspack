...
With the release of [@rspack/browser](/api/javascript-api/browser), you can now **use Rspack directly in any modern browser**—without relying on WebContainers or specific platforms.
