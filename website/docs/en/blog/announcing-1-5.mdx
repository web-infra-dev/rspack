...
We're excited to announce the release of Rspack 1.5!
...
In real-world testing, enabling barrel file optimization delivered significant performance improvements across applications at different scales:
...
Since v1.4, we have delivered several key optimizations to reduce Rspack's installation size, which have already delivered significant results:
