...
Rspack 2.0 maintains compatibility with the webpack ecosystem while introducing more modern defaults, API design, and build outputs for JavaScript development.
