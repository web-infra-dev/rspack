...
Rspack 1.6 has been released with better ESM output, stabilized layers feature, optimized tree shaking for dynamic imports, experimental defer import support, and lazyBarrel enabled by default.
