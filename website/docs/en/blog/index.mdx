...
Rspack 2.0 has been released with Pure ESM packages, better ESM output, portable cache, more precise tree shaking, a lighter dev server architecture, and built-in React Server Components support.
