...
This feature primarily addresses three categories of problems: [builtins](https://v0.rspack.dev/config/builtins) code transformation features, [target](/config/target), and custom [Rule.type](/config/module#ruletype).
