---
description: 'Rspack 0.3 is out, adding support for web workers and the builtin:swc-loader.'
...
For more detailed information about Profile, see [Performance Profiling](/guide/diagnostics/profile).
