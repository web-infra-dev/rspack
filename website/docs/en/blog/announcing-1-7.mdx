...
In Rspack 1.7, we upgraded the used SWC version and supported the above approach. From now on, in most scenarios, SWC upgrades will not affect the normal operation of plugins built with older SWC versions.
