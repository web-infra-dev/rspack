---
description: 'Rspack 1.7 has been released, improving SWC Wasm plugin compatibility, importing assets as bytes, and stabilizing multiple experimental features.'
...
In Rspack 1.5, we stabilized the [Lazy Compilation](/guide/advanced/lazy-compilation) feature and enabled it by default for dynamically imported modules in Rsbuild.
...
- **Constant Inlining Optimization**: This optimization is now stable and enabled by default in production builds.
  - The original [experiments.inlineConst](/config/optimization#optimizationinlineexports) option is deprecated.
...
- **TypeScript Enum Inlining Optimization**: This optimization is now stable.
  - The original [experiments.inlineEnum](/config/optimization#optimizationinlineexports) option is deprecated.
...
- **Type Re-export Check**: This optimization is now stable.
  - The original [experiments.typeReexportsPresence](/config/module-parser#javascripttypereexportspresence) option is deprecated.
