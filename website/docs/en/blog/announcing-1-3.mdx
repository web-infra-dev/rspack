...
- New features
  ...
  - [CircularDependencyRspackPlugin](#circulardependencyrspackplugin): detecting circular dependencies between modules
...
For more details, please checkout [the docs](https://rspack.dev/config/experiments#experimentsbuildhttp).

### CircularDependencyRspackPlugin

We added a built-in plugin CircularDependencyRspackPlugin to Rspack to detect circular dependencies between runtime modules.
...
For more details, please checkout [the docs](https://rspack.dev/config/other-options#amd).
...
See [Announcing Rsdoctor 1.0](https://rsdoctor.dev/zh/blog/release/release-note-1_0) for more details.
...
For more details, see [FAQ - SWC plugin version unmatched](https://rspack.dev/errors/swc-plugin-version).
