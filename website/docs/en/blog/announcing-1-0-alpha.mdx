...
We believe that Lightning CSS will become the shared foundation for the next generation build tools, and Rspack will support more CSS complation features based on Lightning CSS.. Thanks to [@devongovett](https://github.com/devongovett) for creating such an excellent tool.
