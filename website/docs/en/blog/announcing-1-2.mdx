---
description: 'Rspack 1.2 has been released, introducing experimental persistent caching, a faster code splitting algorithm, and Yarn PnP support.'
...
> See [cache](/config/cache) for more details.
