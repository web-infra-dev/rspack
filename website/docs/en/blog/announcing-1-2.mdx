...
- New features
  ...
  - [Faster code splitting algorithm](#faster-code-splitting-algorithm): Experimental feature that significantly improve the code splitting performance after it is enabled.
  - [Yarn pnp](#yarn-pnp)
