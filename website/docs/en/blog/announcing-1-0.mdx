...
- All the developers participating in ByteDance's Rspack Innovator project, such as [Dominus Kelvin](https://x.com/Dominus_Kelvin), [Yannik Peschke](https://x.com/_yanpes), [Russell Canfield](https://x.com/RussellCanfield), who gave us early feedback and advice.
