...
Rspack and Rsbuild v1.1 has been released!
...
The CLI shortcut allows you to clear the console, open the browser, restart the server, or customize any comment you want.
...
In v1.1, the Rust crate `swc_core` has been upgraded to `4.0.2`. Users of the SWC Wasm plugin need to ensure version consistency with `swc_core` being used, otherwise, it may lead to unforeseen issues.
