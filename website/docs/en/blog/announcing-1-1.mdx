...
![10000 React Components with new incremental enabled](https://github.com/user-attachments/assets/7b8aaa3c-296b-4cfe-8bd2-25e1797f152c)
...
Checkout [our docs](https://rspack.dev/config/experiments#experimentsincremental) for more details.
