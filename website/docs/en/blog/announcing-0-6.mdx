---
description: 'Rspack 0.6 is out, with built-in support for mini-css-extract-plugin and new tree-shaking enabled by default.'
...
For more details, please see [CssExtractRspackPlugin](/plugins/css-extract-rspack-plugin#cssextractrspackplugin).
