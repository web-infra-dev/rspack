...
Remove `builtins.css`, please replace it with the CSS-related [`module.parser`](/config/module-parser#parsercssauto) and [`module.generator`](/config/module-generator#generatorcssauto) options that have been introduced.
