---
description: 'Common Rspack questions covering webpack compatibility, performance tradeoffs, plugins, loaders, and framework support.'
sidebar: false
---
...
Rspack internally uses SWC to perform code downgrade compilation which you can configure by [builtin:swc-loader](/guide/features/builtin-swc-loader), so there is no need to use babel-loader to perform code downgrade compilation.
