...
:::warning 已废弃
`CircularDependencyRspackPlugin` 已废弃。请使用 [`CircularCheckRspackPlugin`](/plugins/rspack/circular-check-rspack-plugin)，CircularCheckRspackPlugin 有更好的性能和更合理的 API 设计。
:::
