---
description: '这个插件可以更细致地控制源映射文件（source map）的生成。在特定的 devtool 配置选项设置下，它也会被自动启用。'
---
...
<Attribution url="https://webpack.docschina.org/plugins/eval-source-map-dev-tool-plugin/" />
