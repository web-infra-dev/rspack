---
description: '注意 HMR 不能被用于生产构建，因此你需要通过 process.env.NODEENV 来判断当前是否是开发环境。'
---
...
请参考 [React - Fast Refresh](/guide/integrations/react#fast-refresh) 了解更多信息。
...
请参考 [Preact - Fast Refresh](/guide/integrations/preact#preact-refresh) 了解更多信息。
