---
description: 'externalsPresets.electron、externalsPresets.electronMain、externalsPresets.electronRenderer 和 externalsPresets.electronPreload 配置项均依赖该插件。'
---
...
在 Web 环境中通过 `jsonp` 加载代码块。

### WebWorkerTemplatePlugin

`webworker.WebWorkerTemplatePlugin(options)`

在 Web Worker 环境中通过 `importScripts` 加载代码块。
