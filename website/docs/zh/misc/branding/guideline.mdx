---
description: 'Rspack 在独立使用的情况下都应该写作 Rspack，而不是 rspack 或者 RSPACK，但在命令行或者包名中可以使用小写，如 @rspack/cli。'
---
...
你可以在 [rstack-design-resources](https://github.com/rstackjs/rstack-design-resources) 仓库下找到 Rspack 相关的所有设计资源。
