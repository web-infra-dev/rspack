...
你可以像开发 webpack 插件和 loader 一样，使用 JavaScript 来开发插件和 loader。同时 Rspack 也支持使用 Rust 来开发插件和 loader，参考 [rspack-binding-template](https://github.com/rspack-contrib/rspack-binding-template)
