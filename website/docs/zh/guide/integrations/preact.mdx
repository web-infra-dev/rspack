---
description: '在 Rspack 中使用Preact的指南，涵盖环境配置、集成方式、调试要点、开发模式与常见问题处理。'
---
...
完整示例可参考：[examples/preact](https://github.com/rstackjs/rstack-examples/blob/main/rspack/preact)
...
- 代码注入：指注入与 `@prefresh/core` 和 `@prefresh/utils` 交互的代码，都已集成在 [@rspack/plugin-preact-refresh](https://github.com/rstackjs/rspack-plugin-preact-refresh) 插件中，可通过该插件实现
- 代码转换需要通过 loader 来完成：
...
完整示例可参考：[examples/preact-refresh](https://github.com/rstackjs/rstack-examples/tree/main/rspack/preact-refresh)
