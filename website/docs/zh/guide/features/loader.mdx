...
Rspack 允许你使用社区中绝大多数的 webpack loaders。查看 [awesome-rspack - Rspack loaders](https://github.com/rstackjs/awesome-rstack?tab=readme-ov-file#rspack-loaders) 发现社区提供的 loaders。
