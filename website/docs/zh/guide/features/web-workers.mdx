...
可以通过 [`module.parser.javascript.worker`](/config/module-parser#javascriptworker) 告诉 Rspack 哪些表达式要按 Worker 类入口语法处理：
...
<Attribution url="https://webpack.docschina.org/guides/web-workers/" />
