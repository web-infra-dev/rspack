...
如果你希望修改这个行为，可以使用 [module.parser.asset.dataUrlCondition](/config/module-parser#asset) 来修改全局的配置，或使用 [rules[].parser.dataUrlCondition](/config/module-parser#assetdataurlcondition) 对特定符合条件的模块单独配置。
