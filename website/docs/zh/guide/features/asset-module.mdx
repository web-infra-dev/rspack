---
description: 'Rspack 内置了对资源（如：图片、字体、视频等）的支持，这意味着你不需要任何的 Loader 来处理这些文件。'
---
...
如果你希望修改这个行为，可以使用 [module.parser.asset.dataUrlCondition](/config/module-parser-asset#moduleparserasset) 来修改全局的配置，或使用 [rules[].parser.dataUrlCondition](/config/module-rules#rulesparserdataurlcondition) 对特定符合条件的模块单独配置。
