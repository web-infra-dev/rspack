---
description: '作为一个底层打包工具，Rspack 拥有丰富的技术生态，包含多种框架、工具和解决方案。这些生态项目涵盖了从框架到开发工具的各个方面，能够满足不同场景下的开发需求，提供开箱即用的体验。'
---
...
- Rspack v2 要求 Node.js 版本 20.19+, 22.12+。
- Rspack v1 要求 Node.js 18.12.0 或更高版本。
...
接下来，查看 [配置 Rspack](/config/) 来了解如何配置 Rspack。
