...
在 TypeScript 代码中，可以获取到 Rspack 特有的功能，例如 [import.meta.glob](/api/runtime-api/module-variables#importmetaglob)。
...
1. 添加 TypeScript reference 指令来声明：
   ...
   const modules = import.meta.glob('./dir/*.js'); // 如果没有上面的引用声明，TypeScript 将会抛出错误
   ```
