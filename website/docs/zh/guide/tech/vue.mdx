---
description: '在 Rspack 中使用Vue的指南，涵盖环境配置、集成方式、调试要点、开发模式与常见问题处理，帮助快速定位相关信息。'
---
...
相关示例可以参考 [example-vue3](https://github.com/rstackjs/rstack-examples/tree/main/rspack/vue)。

## Vue 2

Rspack 已经完成对 Vue 2（使用 vue-loader@15）的兼容。
...
export default {
  module: {
    rules: [
      ...
      {
        test: /\.(?:js|mjs|ts)$/, // 如果需要在 Vue SFC 里使用 TypeScript, 请添加该规则
...
相关示例可以参考：[example-vue2](https://github.com/rstackjs/rstack-examples/tree/main/rspack/vue2) 和 [example-vue2-ts](https://github.com/rstackjs/rstack-examples/tree/main/rspack/vue2-ts)。
...
Rspack 提供了一个 Vue JSX 的[示例](https://github.com/rstackjs/rstack-examples/tree/main/rspack/vue3-jsx)可供参考。
