...
添加 `builtin:swc-loader` 以支持 `.js`、`.mjs`、`.jsx`、`.ts` 和 `.tsx`:
...
完整示例可参考：[examples/preact-refresh](https://github.com/rstackjs/rstack-examples/blob/main/rspack/preact-refresh)
