...
在构建完成后，Rsdoctor 会打开构建分析页面。请参考 [Rsdoctor 文档](https://rsdoctor.dev/) 来了解完整功能。

## 配置 Rsdoctor

查看 Rsdoctor 的 [Options](https://rsdoctor.dev/zh/config/options/options) 文档来配置 RsdoctorRspackPlugin 的选项。

## 更多特性

查看 [Rsdoctor 功能导航](https://rsdoctor.dev/zh/guide/start/features) 来了解 Rsdoctor 的所有特性。
