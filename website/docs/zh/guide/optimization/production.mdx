...
如果你需要自定义压缩选项，可以使用 [SwcJsMinimizerRspackPlugin](/plugins/swc-js-minimizer-rspack-plugin) 和 [LightningCssMinimizerRspackPlugin](/plugins/lightning-css-minimizer-rspack-plugin) 来进行配置。
