...
我们意识到这一问题，希望通过 [experiments.rspackFuture.disableTransformByDefault](/config/experiments#disabletransformbydefault) 和 [@rspack/plugin-react-refresh](/guide/react#rspackplugin-react-refresh) 来帮助用户逐渐地迁移到更为正确的方式上来，即第二种方式。
