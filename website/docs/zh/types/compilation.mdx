...
type Compilation = {
  ...
  fileDependencies: FileSystemDependencies; // 本地文件依赖
  contextDependencies: FileSystemDependencies; // 本地目录依赖
  missingDependencies: FileSystemDependencies; // 缺失文件依赖
  buildDependencies: FileSystemDependencies; // 构建文件依赖
