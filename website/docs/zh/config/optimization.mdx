...
有关可用配置项（例如 [`splitChunks.enforceSizeThreshold`](/plugins/webpack/split-chunks-plugin#splitchunksenforcesizethreshold)），请参见 [SplitChunksPlugin](/plugins/webpack/split-chunks-plugin) 页面。
