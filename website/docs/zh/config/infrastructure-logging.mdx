---
description: '指定输出（如特定的插件或 loader）的调试信息。类似 stats.loggingDebug 选项，但适用于基础架构。'
---
...
<Attribution url="https://webpack.docschina.org/configuration/other-options/#infrastructurelogging" />
