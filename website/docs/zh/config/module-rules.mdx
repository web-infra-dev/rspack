...
对于特定的解析器选项及其对应的模块类型，你可以参考 [`module.parser`](/config/module-parser#moduleparser)。
...
对于特定的生成器选项及其对应的模块类型，你可以参考 [`module.generator`](/config/module-generator#modulegenerator)。
