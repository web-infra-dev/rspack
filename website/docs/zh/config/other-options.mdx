---
description: 'Rspack 其他配置参考，涵盖 amd、bail、dependencies 与 ignoreWarnings 等补充配置项。'
---
...
<Attribution url="https://webpack.js.org/configuration/other-options/" />
