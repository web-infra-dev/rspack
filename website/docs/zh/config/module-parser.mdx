...
- [Asset parser 选项](/config/module-parser#parserasset)
- [JavaScript parser 选项](/config/module-parser#parserjavascript)
- [JSON parser 选项](/config/module-parser#parserjson)
- [CSS parser 选项](/config/module-parser#parsercssauto)
...
当使用了不存在的导出时，是否进行警告或报错。默认会遵循 [module.parser.javascript.exportsPresence](#parserjavascriptexportspresence) 的配置。
...
当使用了存在冲突的重导出时，是否进行警告或报错。默认会遵循 [module.parser.javascript.exportsPresence](#parserjavascriptexportspresence) 的配置。
...
`javascript/auto` 模块的解析器选项，和 [`javascript` 的模块的解析器选项](#parserjavascript)相同。
...
`javascript/dynamic` 模块的解析器选项，和 [`javascript` 的模块的解析器选项](#parserjavascript)相同。
...
`javascript/esm` 模块的解析器选项，和 [`javascript` 的模块的解析器选项](#parserjavascript)相同。
...
和 [`module.parser["css/auto"].namedExports`](#parsercssautonamedexports) 一样。
...
和 [`module.parser["css/auto"].url`](#parsercssautourl) 一样。
...
参考 [`module.parser["css/auto"].resolveImport`](#parsercssautoresolveimport)。
...
和 [`module.parser["css/auto"].import`](#parsercssautoimport) 一样。
...
和 [`module.parser["css/auto"].animation`](#parsercssautoanimation) 一样。
...
和 [`module.parser["css/auto"].customIdents`](#parsercssautocustomidents) 一样。
...
和 [`module.parser["css/auto"].dashedIdents`](#parsercssautodashedidents) 一样。
