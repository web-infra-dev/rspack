...
`target` 配置中的 esX 只能指定 Rspack runtime 中的代码使用 ECMAScript 版本的语法，如果要指定用户代码的 ECMAScript 版本请使用 [builtin:swc-loader](/guide/builtin-swc-loader.html) 或 [babel-loader](https://www.npmjs.com/package/babel-loader) 或 [swc-loader](https://www.npmjs.com/package/swc-loader) 进行代码降级。
