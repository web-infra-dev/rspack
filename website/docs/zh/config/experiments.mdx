...
目前默认开启 make 和 emitAssets 阶段的增量，这也是之前 Rspack v1.0 的默认行为，我们会随着该特性的进一步稳定默认开启更多阶段的增量。

:::tip
该特性属于实验性特性，可前往 [rspack#8106](https://github.com/web-infra-dev/rspack/issues/8106) 查看其相关进度，也可在此反馈 bugs 以及任何与之相关的反馈信息。
:::
