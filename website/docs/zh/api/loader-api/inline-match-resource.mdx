---
description: 'Inline matchResource 允许你在加载资源时动态改变匹配规则。你可以通过在模块标识符前添加 !=! 前缀来为该模块标识符设置 matchResource。'
---
...
<Attribution url="https://webpack.docschina.org/api/loaders/#inline-matchresource" />
