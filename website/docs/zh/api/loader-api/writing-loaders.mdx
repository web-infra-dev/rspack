---
description: 'Rspack 支持多种 loader 类型，包括同步 loader、异步 loader、ESM loader、Raw loader 和 Pitching loader 等。'
---
...
<Attribution url="https://webpack.docschina.org/api/loaders/#examples" />
