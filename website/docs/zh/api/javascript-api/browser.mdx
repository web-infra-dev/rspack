...
- [napi-rs#2867](https://github.com/napi-rs/napi-rs/issues/2867)： 目前你需要在使用了 `@rspack/browser` 的项目中注入 `process.env.NODE_DEBUG_NATIVE`。如果你使用 Rspack 来打包项目，你可以参考 [DefinePlugin](/plugins/webpack/define-plugin)。
