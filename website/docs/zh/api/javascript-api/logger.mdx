---
description: 'Rspack logger 可以在 loaders 和 plugins 中使用。生成的日志将作为 Stats 的一部分并且可以在 rspack configuration 中配置。'
---
...
<Attribution url="https://webpack.docschina.org/api/logging/" />
