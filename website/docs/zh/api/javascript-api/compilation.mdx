---
description: 'Compilation 对象是 Rspack 构建过程中的核心对象之一，每当 Rspack 执行构建时（包括监听模式下的重新构建），都会创建一个新的 Compilation 实例，它包含了当前构建的所有信息。'
---
...
<Attribution url="https://webpack.docschina.org/api/compilation-object/" />
