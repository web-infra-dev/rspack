...
Rspack 支持 JavaScript 的压缩和转换。你可以使用 Rspack 的 JavaScript API 来编译和转换 JavaScript 代码。以下是一个简单的示例，演示如何使用 Rspack 转换 JavaScript 代码：
...
Rspack 底层使用 SWC 来转换和压缩 JavaScript 代码。上述 API 接受的选项会传递给 SWC。你可以在 SWC 官方文档中了解更多配置选项：
