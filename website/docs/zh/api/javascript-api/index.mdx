...
Rspack 的 JavaScript API 在生命周期和性能特征上与 webpack 存在差异，详见 [JavaScript API 架构](/api/javascript-api/architecture)。
...
<Attribution url="https://webpack.docschina.org/api/node/" />
