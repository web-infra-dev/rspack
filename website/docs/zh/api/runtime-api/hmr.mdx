---
description: '如果你通过 HotModuleReplacementPlugin 启用了模块热替换，它的接口将暴露在 module.hot 和 import.meta.webpackHot 对象下。'
---
...
如果你通过 [HotModuleReplacementPlugin](/plugins/hot-module-replacement-plugin) 启用了模块热替换，它的接口将暴露在 `module.hot` 和 `import.meta.webpackHot` 对象下。
...
<Attribution url="https://webpack.docschina.org/api/hot-module-replacement/" />
