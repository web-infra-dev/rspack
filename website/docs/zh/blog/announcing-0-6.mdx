...
移除 `builtins.css`，请使用引入的 CSS 相关的 [`module.parser`](/config/module-parser-css#moduleparsercssauto) 和 [`module.generator`](/config/module-generator-css#modulegeneratorcssauto) 选项进行替代。
