...
- 新功能
  ...
  - [Lazy compilation 中间件](#lazy-compilation-中间件)
  - [支持 AMD 模块](#支持-amd-模块)
- 性能优化
  - [代码拆分提速 25%](#代码拆分提速-25)
  - [产物体积优化](#产物体积优化)
...
在 Rspack 之前的版本中，你可以通过 [externalsPresets.web](/config/externals#externalspresetsweb) 或 [externalsPresets.webAsync](/config/externals#externalspresetswebasync) 来导入 HTTP/HTTPS 资源，这只是将 HTTP/HTTPS 资源设置为外部资源，然后让浏览器（或其他平台）在运行时获取它们。
