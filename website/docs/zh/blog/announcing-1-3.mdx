...
- 新功能
  - [Lazy compilation middleware](#lazy-compilation-middleware)：实验性功能，简化开发服务器对 lazy compilation 功能的接入
  - [CircularDependencyRspackPlugin](#circulardependencyrspackplugin)：实验性功能，高效检测模块间的循环依赖
