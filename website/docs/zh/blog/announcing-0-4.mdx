...
此功能主要解决三类问题：[内置](https://v0.rspack.dev/config/builtins) 代码转换功能，[目标](/config/target)，和自定义 [Rule.type](/config/module#ruletype)。

1. 移除对一些 [内置](https://v0.rspack.dev/config/builtins) 功能的支持：

- [builtins.relay](https://v0.rspack.dev/config/builtins#builtinsrelay)：移动到 `rspackExperiments.relay`
- [builtins.react](https://v0.rspack.dev/config/builtins#builtinsreact)：移动到 `jsc.transform.react`
- [builtins.emotion](https://v0.rspack.dev/config/builtins#builtinsemotion)：移动到 `rspackExperiments.emotion`
- [builtins.pluginImport](https://v0.rspack.dev/config/builtins#builtinspluginimport)：移动到 `rspackExperiments.import`
