...
在发布 Rspack 1.0 的同时，我们也已经发布了 Rsbuild 1.0 RC 版本，后续 Rsbuild 将不再引入不兼容更新。请参考 [从 Rsbuild 0.x 迁移](https://rsbuild.dev/zh/guide/migration/rsbuild-0-x) 升级到 Rsbuild 1.0 RC。
