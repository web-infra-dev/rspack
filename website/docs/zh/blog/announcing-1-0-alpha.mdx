---
description: 'Rspack 1.0 alpha 现已发布至 npm！在发布 Rspack 1.0 稳定版之前，我们将进行 1～2 个月的测试，以改进 1.0 版本的 API 稳定性和可靠性，并验证对下游项目的影响。'
...
Rspack 1.0 对齐了 webpack 的 [experiment.css](/config/deprecated-options#experimentscss) 默认值，这使得从 webpack 迁移到 Rspack 更加容易。
...
3. 使用 [experiment.css](/config/deprecated-options#experimentscss)，这是 webpack 5 引入的实验性功能，提供 CSS 原生支持。
