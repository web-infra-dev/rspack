...
## [Rspack 2.0 发布公告](/blog/announcing-2-0)

> 2026 年 4 月 28 日

Rspack 2.0 版本发布，带来 Pure ESM、Better ESM、Portable Cache、更精准的 tree shaking、更轻量的 dev server 架构，以及内置 React Server Components 支持。
