...
## [Rspack v1.0 Alpha 发布公告](/blog/announcing-1-0-alpha)
...
Rspack v0.7 版本发布，支持 lazy compilation，能够显著提升大型应用的 dev startup 性能。同时引入了全新的 css-module-lexer，使 CSS 打包速度提升 4 倍。
