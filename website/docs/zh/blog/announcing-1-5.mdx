...
自 1.4.0 以来 Rspack 团队做了一系列的优化来降低 Rspack 的安装尺寸。其中最重要的便是优化 Rspack node binding 的文件尺寸。
...
以一个来自字节的约 40000 多个模块的项目为例，整体 Seal 阶段耗时降低约 50%。
...
为了让 Rspack 用户能够更便捷地使用 Rspack 的模块解析功能，我们已将 [rspack-resolver](https://github.com/web-infra-dev/rspack-resolver) 集成到 Rspack 的 JavaScript API 中，这提供了类似 [enhanced-resolve](https://github.com/webpack/enhanced-resolve) 的模块解析能力。
