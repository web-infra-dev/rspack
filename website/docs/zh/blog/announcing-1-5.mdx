...
- 其他
  - [不再支持 Node.js 16](#停止支持-nodejs-16)
...
为了确保安装体积的持续优化，我们搭建了相关的监控 [CI](https://github.com/web-infra-dev/rspack/blob/main/.github/actions/binary-limit/action.yml)，将其集成到日常的代码质量检查流程中，并将持续关注该指标的变化。
