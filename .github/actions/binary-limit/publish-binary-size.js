// Publishes the ci-profile binary size of a main/v1.x commit to the benchmark
// data branch, so PRs can read a baseline minutes after the binding build instead
// of waiting for the ecosystem benchmark (release build + 40min bench) to finish.
